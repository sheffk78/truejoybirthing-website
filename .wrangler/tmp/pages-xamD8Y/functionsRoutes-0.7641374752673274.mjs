...
import { onRequestPost as __api_confidence_session_ts_onRequestPost } from "/Users/socializerender/Projects/truejoybirthing-website/functions/api/confidence-session.ts"
...
import { onRequest as ___middleware_ts_onRequest } from "/Users/socializerender/Projects/truejoybirthing-website/functions/_middleware.ts"
...
export const routes = [
    ...
    },
  {
      ...
      method: "POST",
      middlewares: [],
      modules: [__api_confidence_session_ts_onRequestPost],
    },
  {

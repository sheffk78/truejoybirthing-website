...
// api/ambassador.ts
var ALLOWED_ORIGINS = ["https://truejoybirthing.com", "https://www.truejoybirthing.com", "http://localhost:4321"];
        ...
        await fetch("https://api.brevo.com/v3/contacts", {
          ...
          body: JSON.stringify({
            ...
            attributes: {
              ...
              AMB_WHY: why,
              AMB_STATUS: "applied",
              AMB_APPLIED_AT: (/* @__PURE__ */ new Date()).toISOString()
            },
            listIds: [6],
            updateEnabled: true
          })
...
// api/confidence-session.ts
var ALLOWED_ORIGINS2 = ["https://truejoybirthing.com", "https://www.truejoybirthing.com", "http://localhost:4321"];
var onRequestPost2 = /* @__PURE__ */ __name(async (context) => {
  const { request, env } = context;
  const origin = request.headers.get("origin") || "";
  if (!ALLOWED_ORIGINS2.some((o) => origin === o || origin.endsWith(".truejoybirthing.com"))) {
    return new Response(JSON.stringify({ error: "Origin not allowed" }), {
      status: 403,
      headers: { "Content-Type": "application/json" }
    });
      ...
      try {
        await fetch("https://api.brevo.com/v3/contacts", {
          ...
          body: JSON.stringify({
            ...
            listIds: [2, 6],
            // 2 = general, 6 = Confidence Session leads
            updateEnabled: true
          })
        });
      } catch (brevoErr) {
...
// api/contact.ts
var ALLOWED_ORIGINS3 = ["https://truejoybirthing.com", "https://www.truejoybirthing.com", "http://localhost:4321"];
var onRequestPost3 = /* @__PURE__ */ __name(async (context) => {
  ...
  if (!ALLOWED_ORIGINS3.some((o) => origin === o || origin.endsWith(".truejoybirthing.com"))) {
    return new Response(JSON.stringify({ error: "Origin not allowed" }), {
      status: 403,
      headers: { "Content-Type": "application/json" }
    });
...
// admin/[[path]].ts
var RAILWAY_BACKEND = "https://truejoybirthing-app-production.up.railway.app";
...
// ../.wrangler/tmp/pages-7WnHMy/functionsRoutes-0.9208674240405443.mjs
var routes = [
  {
  ...
  {
    routePath: "/api/confidence-session",
    mountPath: "/api",
    method: "POST",
    middlewares: [],

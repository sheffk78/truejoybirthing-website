#!/usr/bin/env python3
"""Render NC state OG image using Playwright."""
import asyncio
...
HTML_PATH = str(PROJECT_DIR / 'scripts' / 'og-state-nc-composition.html')
OUTPUT_PATH = str(PROJECT_DIR / 'public' / 'images' / 'og' / 'og-state-nc.png')

...
function assertCompleteness(slug: string, data: any): Assertion[] {
  ...
  const slugOk = typeof data.slug === "string" && /^.+-(tx|nc|ga|sc|ok|oh|in|fl|co|tn|nv|ca|ny|ma|mi|il|ct|ri|pa|az|wa|or|mn|md|nj|va|wi|mo|nm|ut|al|ky|id|ia|ne|ms|ks|la|hi|ak|sd|ar|nd|nh|mt|wy|de|vt|wv)$/.test(data.slug);
  results.push({
    id: "A7",
    city: slug,
    passed: slugOk,

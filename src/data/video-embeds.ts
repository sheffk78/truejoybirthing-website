...
"chicago-il": {
  ...
  "memphis-tn": {
    ...
    description: "Full city guide — 3 hospitals, 4 doulas, costs, and Tennessee Medicaid (TennCare), all in under 5.5 minutes. #memphisdoula #memphisbirth #tennesseemedicaid #birthplan #doula #pregnancymemphis",
    duration: "PT5M25S",
    uploadDate: "2026-07-28T00:00:00-05:00",
    chapters: [
      [0, "Welcome to Memphis"],
      [12, "What This Video Covers"],
      [31, "Methodist University Hospital (Level IV NICU)"],
      [67, "Baptist Memorial Hospital-Memphis (Level III NICU)"],
      [98, "Regional One Health (CNM Midwifery)"],
      [126, "Memphis Doulas (Naturally Nurtured Birth Services)"],
      [148, "Black Doula in Memphis (WhatTheDoula)"],
      [172, "River City Doulas"],
      [193, "Memphis Birth Collective"],
      [219, "The True Joy Birthing App"],
      [245, "Cost Reality ($700-$1,700)"],
      [277, "Insurance & Tennessee Medicaid (TennCare)"],
      [310, "Your Next Step"],
    ],
  },
  "lehi-ut": {

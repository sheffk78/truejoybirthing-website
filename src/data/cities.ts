...
"killeen-tx": {
  ...
  "tacoma-wa": {
    ...
    localDoulas: [
      ...
      { name: "Little Mitzvah Doula Care", photo: "/images/provider-tacoma-wa-little-mitzvah.webp", credential: "Birth Doula, Postpartum Doula", practice: "Little Mitzvah Doula Care", url: "https://www.littlemitzvahdoulacare.com", description: "Overnight postpartum doula care for Tacoma families, offering newborn care, feeding support, and rest for new parents.", costRange: "$35–$50/hr", serviceArea: ["Tacoma", "Fife", "Edgewood"], acceptingClients: true, services: ["Overnight Care"] },
    ],
  ...
  "norfolk-va": {
    ...
    localDoulas: [
      ...
      { name: "Sentara Midwifery Specialists", credential: "LM, CPM", practice: "Sentara Midwifery Specialists", url: "https://www.sentara.com/hospitalslocations/sentara-midwifery-specialists/locations/sentara-midwifery-specialists-hampton", description: "Professional doula serving families in the area.", photo: "", isMidwife: true },
  ...
  "fremont-ca": {
    ...
    localDoulas: [
      ...
      { name: "Pamela Lopes Doula", credential: "Birth Doula", practice: "Pamela Lopes Doula", url: "http://www.pamelalopesdoula.com", description: "Connect it to your Wix website in just a few easy steps: 1.", photo: "" },

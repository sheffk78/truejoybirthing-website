...
export const cities: Record<string, CityData> = {
  "amarillo-tx": {
    ...
    hospitalDetails: [
      { name: "Baptist St. Anthony's Hospital", paragraph: "Baptist St. Anthony's Hospital, in northwest Amarillo, is the largest hospital in the Panhandle and handles a high volume of births with a Level III NICU (contact the hospital directly for current level verification) and a strong maternal-fetal medicine program. Doulas are generally welcome, though visitor policies can shift, so confirm during your hospital tour. If you're delivering at BSA, having your birth plan in hand makes the whole check-in process smoother \u2014 they see a lot of families and move fast. <a href=\"/birth-plan-template/\">Use our free hospital birth plan template</a> to get started." },
      { name: "Northwest Texas Healthcare System", paragraph: "Northwest Texas Healthcare System, also in Amarillo, is a Level III trauma center with a Level III NICU (contact the hospital directly for current level verification) and a broad obstetric program that serves many Medicaid-covered families. Honestly, both hospitals here serve a huge geographic area \u2014 families drive hours from surrounding towns, so the L&amp;D units are used to handling a lot. If we're being real, that means coming in with your preferences written down is even more important." },
    ],
    birthCenterDetails: [
    ],
  ...
  "arlington-tx": {
    ...
    hospitalDetails: [
      ...
      { name: "Texas Health Arlington Memorial", paragraph: "Texas Health Arlington Memorial (800 W Randol Mill Rd) is a Level III Trauma Center with a DSHS-certified Level III NICU and DSHS-certified Level III Maternal care designation \u2014 certified by the Texas Department of State Health Services, one of the stronger maternal-care setups in Tarrant County. It has a full-service breast center and advanced imaging on campus. Doulas are generally welcome as part of your support team, though visitor policies can change, so check before your tour. Having a birth plan ready makes the intake conversation smoother, especially when you\u2019re already in labor. <a href=\"/birth-plan-template/\">Use our free hospital birth plan template</a> to get started." },
    ],
    birthCenterDetails: [
    ...
    faqs: [
      ...
      { q: "Which hospitals in Arlington accommodate birth plans?", a: "Medical City Arlington and Texas Health Arlington Memorial both accommodate birth plans. Medical City has a Level III NICU and maternal-fetal medicine; Texas Health Arlington Memorial has a DSHS-certified Level III NICU and DSHS-certified Level III Maternal designations. Always confirm your hospital's policy during your tour." },
  ...
  "austin-tx": {
    ...
    hospitalDetails: [
      { name: "St. David's South Austin", paragraph: "St. David's South Austin Medical Center, in South Austin off Ben White Boulevard, is one of the busiest L&amp;D units in the city with a Level III NICU (contact the hospital directly for current level verification) and a strong maternal-fetal medicine program. Doulas are generally welcome as part of your support team. If you're delivering at St. David's, bring your birth plan \u2014 this is one of the highest-volume birth hospitals in the city and having your preferences written down makes the conversation easier. <a href=\"/birth-plan-template/\">Use our free hospital birth plan template</a> to get started." },
  ...
  "denton-tx": {
    ...
    hospitalDetails: [
      { name: "Texas Health Denton", paragraph: "Texas Health Denton, in South Denton off I-35E, has a DSHS-certified Level III NICU and a strong maternal-fetal medicine program \u2014 it's the go-to for many Denton families. Doulas are generally welcome, though visitor policies can change. Texas Health Denton is well-equipped and busy, so having your birth plan and a doula who knows the flow makes everything smoother. <a href=\"/birth-plan-template/\">Use our free hospital birth plan template</a> to get started." },
      { name: "Medical City Denton", paragraph: "Medical City Denton, in North Denton, also has a Level III NICU (contact the hospital directly for current level verification) and a solid obstetric program. Denton is lucky to have two strong hospitals \u2014 but both can get busy, especially during peak delivery seasons. Write your plan before contractions start." },
    ],
    birthCenterDetails: [
  ...
  "frisco-tx": {
    ...
    hospitalDetails: [
      ...
      { name: "Medical City Frisco", paragraph: "Medical City Frisco, also on the north side, has a Level III NICU (contact the hospital directly for current level verification) and a strong obstetric program. Frisco's population has exploded, and both hospitals have scaled up fast. If we're being real, that means they're busy \u2014 come with your preferences written down and a doula who can help you hold the line." },
    ],
    birthCenterDetails: [
  ...
  "garland-tx": {
    ...
    hospitalDetails: [
      { name: "Baylor Scott & White Garland", paragraph: "Baylor Scott &amp; White Garland, in the Centerville/Marsh area, serves the entire Garland community with a Level III NICU (contact the hospital directly for current level verification) and a strong obstetric program. It's well-established and handles a high volume of births \u2014 having your birth plan ready before you walk in makes everything easier. <a href=\"/birth-plan-template/\">Use our free hospital birth plan template</a> to get started." },
  ...
  "mckinney-tx": {
    ...
    hospitalDetails: [
      ...
      { name: "Medical City McKinney", paragraph: "Medical City McKinney, also serving northern Collin County, has a Level III NICU (contact the hospital directly for current level verification) and a solid obstetric program. McKinney families are well-served by both hospitals \u2014 but both are busy, especially during peak delivery times. If we're being real, knowing your preferences before you're in labor beats figuring them out on the spot." },
    ],
    birthCenterDetails: [
  ...
  "plano-tx": {
    ...
    heroLocalDetail: "Medical City Plano has a Level III NICU (contact the hospital directly for current level verification) and Texas Health Plano is just off Legacy Drive in West Plano \u2014 both are busy, high-volume hospitals, and US-75, the Dallas North Tollway, and SH-121 all converge here, so afternoon rush around Legacy Drive and Legacy West can add 15 minutes you don't need in labor. Arbor Hills Nature Preserve is the walking spot every Plano mom recommends for third-trimester evenings \u2014 shaded trails, paved paths, and a nature playground if you've got older kids in tow. Legacy, Willow Bend, and Lakeside on Legacy are where you'll find the densest clusters of young families.",
    hospitalDetails: [
      { name: "Texas Health Plano", paragraph: "Texas Health Plano, in West Plano on Legacy Drive, is one of the busiest L&amp;D units in Collin County with a DSHS-certified Level III NICU and a strong maternal-fetal medicine program. It sees a huge volume of births \u2014 they're well-equipped and experienced, but that pace means having your preferences written down is the best way to make sure they don't get lost in the shuffle. <a href=\"/birth-plan-template/\">Use our free hospital birth plan template</a> to get started." },
      { name: "Medical City Plano", paragraph: "Medical City Plano, in Central Plano, also has a high-volume L&amp;D with a Level III NICU (contact the hospital directly for current level verification) and a strong obstetric program." },
  ...
  "waco-tx": {
    ...
    hospitalDetails: [
      { name: "Baylor Scott & White Medical Center \u2013 Hillcrest", paragraph: "Baylor Scott & White \u2013 Hillcrest, off I-35 and University Parks Drive, is McLennan County\u2019s only dedicated Women\u2019s & Children\u2019s Center, with 14 labor and delivery rooms, 26 mother-baby rooms, and a 30-bed Level III NICU (contact the hospital directly for current level verification). Doulas are generally welcome as part of your support team, though visitor policies can change, so check before your tour. If you\u2019re delivering here, having a birth plan ready makes the intake conversation smoother \u2014 especially when you\u2019re already in labor and don\u2019t want to be explaining everything from scratch. <a href=\"/birth-plan-template/\">Use our free hospital birth plan template</a> to get started." },

...
"odessa-tx": {
  ...
  "college-station-tx": {
    ...
    enableBlogResources: true,
    localDoulas: [
      { name: "Mallory Villafuerte", credential: "Birth Doula", practice: "The Crunchy-ish Doula", url: "https://www.crunchydoula.com", services: ["Birth Doula", "Postpartum", "Childbirth Education"], serviceArea: ["Tyler", "Longview", "East Texas"], costRange: "$800\u2013$2,000", acceptingClients: true, description: "Evidence-based, faith-centered birth doula and childbirth educator serving Tyler and East Texas." },
      { name: "Kayley Hamilton", credential: "Birth Doula", practice: "Kayley Hamilton Doula", services: ["Birth Doula", "Postpartum", "Prenatal Support"], serviceArea: ["Tyler", "East Texas"], costRange: "$800\u2013$2,000", acceptingClients: true, description: "Birth and postpartum doula in Tyler who nurtures the mother as a whole \u2014 spiritually, physically, and emotionally." },
      { name: "Camilla Morgan", credential: "Birth Doula", practice: "Camilla Morgan Doula", services: ["Birth Doula", "Postpartum", "Breastfeeding Support"], serviceArea: ["Tyler", "East Texas"], costRange: "$800\u2013$2,200", acceptingClients: true, description: "Birth and postpartum doula with 5 years of experience providing unwavering support through childbirth." },
      { name: "Tabitha Oogjen", credential: "Birth Doula", practice: "Mama Bare Doula LLC", services: ["Birth Doula", "Postpartum"], serviceArea: ["Tyler", "East Texas"], costRange: "$800\u2013$2,000", acceptingClients: true, description: "Certified birth doula serving East Texas families in hospital, birth center, and home settings." },
    ],
    ...
    birthCenterDetails: [
      { name: "Azalea Birth Center", paragraph: "Azalea Birth Center, on South Broadway in central Tyler, is a freestanding birth center run by midwife Vicky Wells, offering water birth and midwife-attended out-of-hospital birth in a home-like setting." },
    ],

...
export const cities: Record<string, CityData> = {
  ...
  "fremont-ca": {
    ...
    localDoulas: [
      ...
      { name: "Doula Studios", credential: "Birth Doula", practice: "Doula Studios", url: "https://doulastudios.com", description: "We birth your product We build bespoke teams of engineers, operators, and manufacturers purpose-built for your mission.", photo: "https://doulastudios.com/assets/alivecor/alivecor_hero.png", acceptsMedicaid: true },

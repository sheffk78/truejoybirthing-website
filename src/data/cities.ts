...
export const cities: Record<string, CityData> = {
  ...
  "san-antonio-tx": {
    ...
    faqs: [
      ...
      { q: "Are there birth centers in San Antonio?", a: "Yes \u2014 San Antonio has several freestanding birth centers including Birth Center Stone Oak (Stone Oak area), Community Birth Group (East Side), and Central Texas Birth Center (central SA). Nearby options outside Bexar County include birth centers in New Braunfels and the Austin area. Most you deliver at one of the major hospitals (Methodist, University, Baptist, Children\u2019s Hospital of SA), but out-of-hospital birth is growing here. <a href=\\\"/birth-plan-template/\\\">Grab the free birth plan template</a> to think through whether a birth center or hospital is right for you." },
  ...
  "spokane-wa": {
    ...
    faqs: [
      ...
      { q: "Does Washington Medicaid cover doula services in Spokane?", a: "Yes! Great news — Medicaid covers doula services in Spokane. Here's your next step: call your Medicaid plan and ask \"Do you cover doula services?\" — they'll walk you through it. You deserve support, and some plans are starting to help pay for it." },
  ...
  "portland-or": {
    ...
    faqs: [
      ...
      { q: "Does OHP cover birth center deliveries in Portland?", a: "Yes! Great news — Medicaid covers doula services in Portland. Here's your next step: call your Medicaid plan and ask \"Do you cover doula services?\" — they'll walk you through it. You deserve support, and some plans are starting to help pay for it." },

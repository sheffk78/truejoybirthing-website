...
export const cities: Record<string, CityData> = {
  ...
  "round-rock-tx": {
    ...
    nearbyCities: ["austin-tx", "killeen-tx", "leander-tx"],
  },
  "leander-tx": {
    city: "Leander",
    state: "TX",
    ...
    costHigh: 2200,
    shelbiServesHere: false,
    culture: "Leander is the fastest-growing suburb in the Austin metro \u2014 its population has roughly doubled since 2010 to around 80,000, driven by young tech families moving into master-planned communities along the 183A Toll Road. The birth community is small but emerging, with most doulas based in nearby Cedar Park, Round Rock, or Austin proper. Williamson County\u2019s explosive growth means St. David\u2019s Round Rock sees a huge volume of Leander families, and advance planning matters when you\u2019re driving 15\u201320 minutes from a new subdivision to the hospital. Austin Area Birthing Center opened a Leander-area location, giving families an out-of-hospital option closer to home.",
    heroLocalDetail: "St. David\u2019s Round Rock Medical Center sits at 2400 Round Rock Ave, about 15 minutes south via the 183A Toll Road \u2014 that\u2019s your fastest, most reliable route from Leander at any time of day. The 183A Toll Road connects Leander directly to Round Rock and Cedar Park without hitting I-35 traffic, and it\u2019s the route you want to have memorized before labor starts. During afternoon rush, the I-35 stretch between SH 45 and the Round Rock Ave exit slows badly, but 183A stays moving. For third-trimester walks, Robin Bledsoe Park in Leander and the Brushy Creek Lake Park trail in Cedar Park are flat, paved, and popular with expectant moms. The neighborhoods along 183A \u2014 Crystal Falls, Mason Hills, Travisso, and the newer Devine Lake Park area \u2014 are where most young families are clustering.",
    hospitalDetails: [
      { name: "St. David\u2019s Round Rock Medical Center", paragraph: "St. David\u2019s Round Rock Medical Center, at 2400 Round Rock Ave about 15 minutes south via 183A Toll Road, is the primary hospital for Leander families. It has a verified Level II NICU as listed on the St. David\u2019s HealthCare NICU specialties page, plus a full women\u2019s health program and Magnet\u00ae recognition for nursing excellence. With the rapid growth of northern Williamson County, this hospital sees a high volume of births from Leander, Liberty Hill, and Cedar Park families. If you\u2019re delivering here, bring your birth plan \u2014 this unit moves fast, and having your preferences written down makes the intake conversation smoother when you\u2019re already in labor. <a href=\"/birth-plan-template/\">Use our free hospital birth plan template</a> to get started." },
      { name: "Ascension Seton Northwest Hospital", paragraph: "Ascension Seton Northwest Hospital, at 11111 Research Boulevard in Austin about 20 minutes south via 183A and US-183, has a Level III NICU (contact the hospital directly for current NICU level verification) and serves as a higher-acuity backup for Leander families who need maternal-fetal medicine or a more specialized neonatal unit. The drive from Leander via 183A to US-183 to the Research Blvd exit is straightforward but can back up on weekday mornings when Austin commuters flood US-183 south. <a href=\"/birth-plan-template/\">Use our free hospital birth plan template</a> so your team has something specific to work from." },
    ],
    birthCenterDetails: [
      { name: "Austin Area Birthing Center \u2014 Leander Location", paragraph: "Austin Area Birthing Center, a CABC-accredited freestanding birth center founded in 1987, opened a Leander-area location serving northern Williamson County families. CNMs and CPMs staff the center, offering water birth, VBAC support, and midwife-led prenatal and postpartum care with transfer agreements to St. David\u2019s and Ascension Seton hospitals. If you\u2019re in Leander and planning an out-of-hospital birth, this is your closest dedicated birth center \u2014 and having a doula who knows the birth center space and the hospital transfer protocols makes your safety net feel solid. Call ahead to confirm current availability and schedule a tour." },
    ],
    medicaidNote: "Texas Medicaid covers doula services as of September 2024 under SB 750 for eligible enrollees, including Williamson County\u2019s STAR managed care plans. Williamson County\u2019s rapid growth means many newly enrolled families \u2014 contact your Medicaid managed care plan to confirm doula coverage, as some plans are still completing their doula network setup. Call Texas Medicaid at 1-877-543-7669 or visit YourTexasBenefits.com.",
    insuranceNote: "Whether doula services are partially covered varies by plan in the Leander area. The Austin metro\u2019s tech-sector employers increasingly include maternity wellness benefits that may cover doula support \u2014 check with your HR department. HSA and FSA funds can also be applied toward out-of-pocket doula costs.",
    faqs: [
      { q: "How much does a doula cost in Leander?", a: "Expect to pay $1,200 to $2,200 for a birth doula in Leander. Most doulas serving Leander are based in Cedar Park, Round Rock, or Austin and travel north, so start your search early and ask about travel fees upfront. The investment typically covers prenatal visits, labor support, and postpartum check-ins. Grab the <a href=\"/birth-plan-template/\">free birth plan template</a> and start thinking about what matters most to you." },
      { q: "Does Medicaid cover doulas in Leander?", a: "Yes! Great news \u2014 Medicaid covers doula services in Leander under SB 750. That includes Williamson County\u2019s STAR managed care plans. Here\u2019s your next step: call your Medicaid plan and ask \u201cDo you cover doula services?\u201d \u2014 they\u2019ll walk you through it, or call 1-877-543-7669 directly. You can also check online at YourTexasBenefits.com. You deserve support, and now your insurance helps pay for it." },
      { q: "Which hospitals near Leander accommodate birth plans?", a: "St. David\u2019s Round Rock Medical Center (verified Level II NICU, about 15 minutes via 183A) is the closest and most popular option for Leander families. Ascension Seton Northwest in Austin (Level III NICU \u2014 contact hospital directly for current verification, about 20 minutes) handles higher-acuity cases. Always confirm your hospital\u2019s current visitor and support-person policies during your tour. <a href=\"/birth-plan-template/\">Grab the free birth plan template</a> so you walk in knowing exactly what you want." },
      { q: "Are there birth centers in Leander?", a: "Austin Area Birthing Center has a Leander-area location offering midwife-led birth in a freestanding birth center setting with water birth and VBAC support. It\u2019s CABC-accredited and has been serving Austin-area families since 1987. <a href=\"/birth-plan-template/\">Grab the free birth plan template</a> to think through whether a birth center or hospital is right for you." },
  ...
  "colorado-springs-co": {
    ...
    faqs: [
      ...
      { q: "Does Colorado Medicaid cover doula services?", a: "Yes! Great news — Medicaid covers doula services in Colorado Springs. This is thanks to HB 23. Here's your next step: call your Medicaid plan and ask \"Do you cover doula services?\" — they'll walk you through it. You deserve support, and now your insurance helps pay for it." },
  ...
  "seattle-wa": {
    ...
    faqs: [
      { q: "Does Medicaid cover doulas in Seattle?", a: "Yes! Great news — Medicaid covers doula services in Seattle. Here's your next step: call your Medicaid plan and ask \"Do you cover doula services?\" — they'll walk you through it. You deserve support, and now your insurance helps pay for it." },

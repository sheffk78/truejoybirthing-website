...
"denton-tx": {
  ...
  "longview-tx": {
    ...
    lng: -96.6397,
    localDoulas: [
      { name: "Little Lilacs Birth Services", practice: "Little Lilac Birth Services", url: "https://littlelilacs.com", services: ["Birth Doula", "Postpartum", "Childbirth Education", "Lactation Support", "Placenta Encapsulation"], serviceArea: ["McKinney", "Dallas", "Plano", "Frisco", "DFW"], costRange: "$950\u2013$2,700", acceptingClients: true, description: "A team of doulas serving McKinney and the broader DFW area with birth, postpartum, and education support." },
      { name: "Amie Ivy Doula", practice: "Amie Ivy Doula", services: ["Birth Doula", "Postpartum"], serviceArea: ["McKinney", "Collin County"], acceptingClients: true, description: "Birth and postpartum doula serving McKinney and Collin County families with personalized, evidence-based support." },
      { name: "Babymoon Concierge", practice: "Babymoon Concierge", url: "https://www.babymoonconcierge.com", services: ["Birth Doula", "Postpartum", "Childbirth Education"], serviceArea: ["McKinney", "Collin County", "DFW"], acceptingClients: true, description: "McKinney birth and postpartum doula concierge service connecting families with experienced doulas." },
    ],
...
{ name: "Amelia Protiva, Birth Doula & Photographer", credential: "Postpartum Doula", practice: "Amelia Protiva, Birth Doula & Photographer", url: "http://ameliaprotiva.com", description: "Doula care rooted in rural Missouri.", photo: "https://images.squarespace-cdn.com/content/v1/691217c649987466a21cc93a/9d3811ec-de57-4091-b3e6-79a27adbb41a/Birth+Becomes+Her%E2%80%93Lukas_0011.jpg", costRange: "Contact for pricing",
  ...
  "moreno-valley-ca": {
    ...
    localDoulas: [
      { name: "Holistic Doula LLC", credential: "Birth Doula", practice: "Holistic Doula LLC", url: "https://www.holistic-doula.com", description: "Acompañamiento integral y culturalmente sensible. Acompañamos a mujeres y familias latinas en cada etapa de la maternidad.", photo: "/images/doulas/holistic-doula-san-bernardino.webp", services: ["Birth Doula", "Postpartum", "Prenatal Care"], costRange: "Contact for pricing" },
      { name: "4 The Moms Southern California Postpartum Doula Support", credential: "Postpartum Doula", practice: "4 The Moms Southern California Postpartum Doula Support", url: "https://www.4themoms.org", description: "A holistic, evidence-based postpartum doula service supporting families through the transitional period of the 4th trimester.", photo: "/images/doulas/4themoms-san-bernardino.webp", services: ["Postpartum", "Lactation", "Breastfeeding Support", "Overnight Care"], costRange: "Contact for pricing" },
      { name: "The Serene Mother Birth Doula", credential: "Birth Doula", practice: "The Serene Mother Birth Doula", url: "https://www.theserenemother.com", description: "Certified Birth Doula and Certified Body Ready Method Pro serving the Murrieta, Temecula and surrounding areas. Accepts Kaiser, Medi-Cal, IEHP.", photo: "https://static.wixstatic.com/media/1f3930_8b35e7990b2c4ed5aaea825083f60de0~mv2.png/v1/fill/w_460,h_400,al_c,lg_1,q_85,enc_avif,quality_auto/IMG_0249_PNG.png", services: ["Birth Doula", "Postpartum", "Prenatal Care"], costRange: "Contact for pricing" },
      { name: "Gem of the Valley Doula Services", credential: "Birth Doula", practice: "Gem of the Valley Doula Services", url: "https://www.yelp.com/biz/gem-of-the-valley-doula-services-murrieta", description: "Professional doula serving families in the Inland Empire.", photo: "/images/doulas/gem-valley-moreno-valley-ca.webp", services: ["Birth Doula", "Postpartum"], costRange: "Contact for pricing" },
      { name: "Raising Birth Doula Care", credential: "Birth Doula", practice: "Raising Birth Doula Care", url: "https://www.instagram.com/raisingbirthdoula", description: "Professional doula serving families in the Inland Empire.", services: ["Birth Doula"], costRange: "Contact for pricing" },
    ],

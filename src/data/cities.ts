...
export const cities: Record<string, CityData> = {
  ...
  "corpus-christi-tx": {
    ...
    enableBlogResources: true,
    localDoulas: [
      { name: "Great Expectations", practice: "Best Dallas Doulas", url: "https://www.bestdallasdoulas.com", services: ["Birth Doula", "Postpartum", "Childbirth Education", "Placenta Encapsulation"], serviceArea: ["Dallas", "Fort Worth", "DFW"], costRange: "$900\u2013$2,800", acceptingClients: true, description: "Dallas\u2019s premier doula agency matching families with experienced birth and postpartum doulas across the DFW metroplex." },
      { name: "Circle Birth", practice: "Circle Birth", url: "https://www.circlebirth.com", services: ["Birth Doula", "Postpartum", "Childbirth Education"], serviceArea: ["Dallas", "Austin", "Houston"], costRange: "$1,000\u2013$2,800", acceptingClients: true, description: "Circle Birth provides expert doula matching across Texas, serving Dallas families with experienced doulas for all birth settings." },
      { name: "North Dallas Doulas", practice: "North Dallas Doulas", url: "https://www.northdallasdoulas.com", services: ["Birth Doula", "Postpartum", "Lactation Support"], serviceArea: ["Dallas", "Plano", "Richardson", "Addison"], acceptingClients: true, description: "North Dallas Doulas provides personalized birth and postpartum doula support across the northern Dallas suburbs." },
      { name: "Delighted to Doula", practice: "Delighted to Doula", url: "https://www.delightedtodoula.org", services: ["Birth Doula", "Postpartum"], serviceArea: ["Dallas", "DFW"], costRange: "$900\u2013$2,500", acceptingClients: true, description: "Dallas postpartum and birth doula services offering compassionate, evidence-based support." },
      ...
      { name: "LaJoi Carter", services: ["Birth Doula", "Postpartum"], serviceArea: ["Dallas"], costRange: "$1,000-$1,500", acceptingClients: true, description: "Birth and postpartum doula serving Dallas families." },
      ...
      { name: "Cortni Simon", credential: "RN", services: ["Birth Doula", "Postpartum"], serviceArea: ["Dallas"], costRange: "$150-$1,500", acceptingClients: true, description: "Registered nurse and birth doula for Dallas families." },
    ],
    ...
    faqs: [
      ...
      { q: "How much does a doula cost in Dallas?", a: "Expect to pay $900 to $2,800 for a doula in Dallas. If you\u2019re looking for bilingual support, reach out early. <a href=\"/birth-plan-template/\">Grab the free birth plan template</a> and start thinking." },

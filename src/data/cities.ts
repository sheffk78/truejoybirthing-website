...
"killeen-tx": {
  ...
  "cary-nc": {
    ...
    localDoulas: [
      ...
      { name: "Tara Flowers", credential: "CBD(AWWS)", practice: "Flowers Doula Services", description: "Certified birth doula with 7 years of experience serving the Triangle area. Known for providing compassionate, client-centered birth support.", costRange: "$1,200", serviceArea: ["Cary", "Raleigh", "Triangle area"], services: ["Birth Doula"], acceptingClients: true, isVerified: false },
      { name: "Amanda Smith", credential: "CD(DONA)", practice: "Hineni Birth and Beyond LLC", description: "DONA International certified birth doula offering both birth and postpartum support services to families in Cary and the Triangle.", costRange: "$1,200–$1,400", serviceArea: ["Cary", "Raleigh", "Triangle area"], services: ["Birth Doula", "Postpartum Doula"], acceptingClients: true, isVerified: false },
      { name: "Kelly Rutan", credential: "ProDoula Certified", practice: "Doulas of Raleigh", url: "https://www.doulasofraleigh.com", description: "Founder and co-owner of Doulas of Raleigh, a ProDoula-certified agency offering labor, postpartum, education, and placenta encapsulation services. Accepts Carrot, Maven, and Progeny workplace benefits.", costRange: "Contact for pricing", serviceArea: ["Cary", "Raleigh", "Durham", "Chapel Hill", "Triangle area"], services: ["Birth Doula", "Postpartum Doula", "Childbirth Education", "Placenta Encapsulation"], acceptingClients: true, isVerified: false },
  ...
  "denver-co": {
    ...
    localDoulas: [
      ...
      { name: "Krystal", credential: "Birth Doula, RN", practice: "Doulas of Denver", url: "https://www.doulasofdenver.com", description: "Denver doula agency pairing families with pre-screened, certified, insured doulas. Founded by an RN — matches you with the right doula for your birth.", costRange: "~$1,000", serviceArea: ["Denver", "Aurora", "Arvada", "Centennial", "Highlands Ranch", "Lakewood", "Littleton", "Thornton", "Westminster"], services: ["Birth Doula", "Postpartum Care", "Overnight Newborn Care", "Sleep Coaching", "Placenta Encapsulation"], acceptingClients: true, isVerified: false },
      { name: "Melissa Sexton & Samantha Venn", credential: "Certified and Registered Midwives (RM, CPM)", practice: "Meadowsweet Midwifery", url: "https://www.meadowsweetmidwifery.com", photo: "/images/doulas/meadowsweet-midwifery.webp", description: "Home birth midwifery practice serving Denver since 2010. Melissa has attended births since 2003; Samantha is a CPM and child passenger safety technician. Offering prenatal, birth, and postpartum care with a focus on empowering, enriching birth experiences.", isMidwife: true, costRange: "$6,500 (global fee)", serviceArea: ["Denver", "Lakewood", "Arvada", "Englewood"], services: ["Home Birth", "Prenatal Care", "Postpartum Care", "Lactation Support", "Water Birth"], acceptingClients: true, isVerified: false },
      { name: "Sena Johnson", credential: "Registered Midwife (RM)", practice: "Birth Choice Association", url: "https://www.denvermidwife.com", photo: "/images/doulas/sena-johnson.webp", description: "Denver's senior homebirth midwife with 38 years of experience and 1,100+ births attended. Offers holistic midwifery care including Craniosacral Therapy, Reiki, and herbal support. Inclusive and affirming care for all families.", isMidwife: true, costRange: "Contact for consultation", serviceArea: ["Denver", "Lakewood", "Arvada"], services: ["Home Birth", "Prenatal Care", "Postpartum Care", "Craniosacral Therapy", "Herbal Support", "Newborn Care"], acceptingClients: true, isVerified: false },
    ],

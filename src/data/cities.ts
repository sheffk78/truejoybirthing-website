  ...
  "corpus-christi-tx": {
    ...
    localDoulas: [
      ...
      { name: "Partum Health", practice: "Partum Health Dallas", url: "https://www.partumhealth.com/care/dallas-texas-postpartum-doula", services: ["Postpartum", "Lactation"], serviceArea: ["Dallas", "DFW"], costRange: "$35\u2013$50/hour", acceptingClients: true, description: "Partum Health connects Dallas families with vetted postpartum doulas and lactation consultants." },
          { name: "Felicia Melton", practice: "Naturally Nestin", url: "https://naturallynestin.com", services: ["Birth Doula", "Postpartum", "Childbirth Education", "Lactation Support"], serviceArea: ["Dallas", "DFW"], costRange: "$1,800-$3,500", acceptingClients: true, description: "DONA-trained birth and CAPPA-certified postpartum doula serving Dallas families." },
      ...
      { name: "Tianna Proctor", services: ["Birth Doula", "Postpartum"], serviceArea: ["Dallas"], costRange: "$1,200-$1,700", acceptingClients: true, description: "Birth doula offering compassionate labor support for Dallas families." },
      { name: "Samantha Clay", services: ["Birth Doula", "Postpartum"], serviceArea: ["Dallas"], costRange: "$1,000-$1,500", acceptingClients: true, description: "Birth and postpartum doula providing continuous labor support." },

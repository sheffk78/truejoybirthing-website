...
{ name: "Amelia Protiva, Birth Doula & Photographer", credential: "Postpartum Doula", practice: "Amelia Protiva, Birth Doula & Photographer", url: "http://ameliaprotiva.com", description: "Doula care rooted in rural Missouri.", photo: "https://images.squarespace-cdn.com/content/v1/691217c649987466a21cc93a/9d3811ec-de57-4091-b3e6-79a27adbb41a/Birth+Becomes+Her%E2%80%93Lukas_0011.jpg", costRange: "Contact for pricing",
  ...
  "san-bernardino-ca": {
    ...
    localDoulas: [
      ...
      { name: "Holistic Doula LLC", credential: "Birth Doula", practice: "Holistic Doula LLC", url: "https://www.holistic-doula.com", description: "Acompañamiento integral y culturalmente sensible. Acompañamos a mujeres y familias latinas en cada etapa de la maternidad.", photo: "/images/doulas/holistic-doula-san-bernardino.webp", services: ["Birth Doula", "Postpartum", "Prenatal Care"], costRange: "Contact for pricing" },
      { name: "4 The Moms Southern California Postpartum Doula Support", credential: "Postpartum Doula", practice: "4 The Moms Southern California Postpartum Doula Support", url: "https://www.4themoms.org", description: "A holistic, evidence-based postpartum doula service supporting families through the transitional period of the 4th trimester.", photo: "/images/doulas/4themoms-san-bernardino.webp", services: ["Postpartum", "Lactation", "Breastfeeding Support", "Overnight Care"], costRange: "Contact for pricing" },
      { name: "Two Moons Doula Services", credential: "Birth Doula", practice: "Two Moons Doula Services", url: "https://m.yelp.com/biz/two-moons-doula-services-san-bernardino-county-3", description: "Formerly offered birth doula support, Bengkung belly binding, yoni steaming, and Closing of the Bones ceremonies in San Bernardino County. This practice is currently closed.", photo: "/images/doulas/placeholder-doula.png", costRange: "Contact for pricing", acceptingClients: false },
      { name: "Raising Birth Doula Care", credential: "Birth Doula", practice: "Raising Birth Doula Care", url: "https://www.instagram.com/raisingbirthdoula", description: "Birth doula serving Inland Empire families with personalized labor support, prenatal education, and postpartum care.", photo: "/images/doulas/placeholder-doula.png", costRange: "Contact for pricing" },
      { name: "Birthy Matters Doula Services and Birth Photography", credential: "Birth Doula", practice: "Birthy Matters Doula Services and Birth Photography", url: "https://www.birthmattersnyc.com", description: "Birth doula and birth photography services for San Bernardino families, offering continuous labor support and birth storytelling.", photo: "/images/doulas/placeholder-doula.png", costRange: "Contact for pricing" },
    ],
    medicaidNote: "Yes — California's Medi-Cal program covers doula services as a state benefit, with reimbursement rates around $1,587 per pregnancy. Families on Medi-Cal can access doula support through the PAVE (Providing Access and doula Viability through Equity) program. Ask your doula whether they are a PAVE-enrolled Medi-Cal provider.",

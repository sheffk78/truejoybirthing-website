...
export const cities: Record<string, CityData> = {
  ...
  "denver-co": {
    ...
    birthCenterDetails: [],
    localDoulas: [
      { name: "Sonja Spitzer", credential: "CAPPA Certified Postpartum Doula, CPD", practice: "Embrace Birth Services", url: "https://embracebirthservices.com", description: "Birth and postpartum doula serving the Denver Metro area. CAPPA certified postpartum doula and Allo Doula Academy certified professional doula.", costRange: "$1,200–$1,900", serviceArea: ["Denver", "Golden", "Lakewood", "Sunnyside"], services: ["Birth Doula", "Postpartum Doula", "Childbirth Education", "Loss Support"], acceptingClients: true },
      { name: "Krystal", credential: "Birth Doula", practice: "Doulas of Denver", url: "https://www.doulasofdenver.com", description: "Birth doula support, overnight newborn care, and sleep coaching for Denver and surrounding areas.", costRange: "~$1,000", serviceArea: ["Denver", "Aurora", "Arvada", "Centennial", "Highlands Ranch", "Lakewood", "Littleton", "Thornton", "Westminster"], services: ["Birth Doula", "Postpartum Care", "Overnight Newborn Care", "Sleep Coaching", "Placenta Encapsulation"], acceptingClients: true },
      { name: "Melissa Sexton & Samantha Venn", credential: "Certified and Registered Midwives (RM)", practice: "Meadowsweet Midwifery", url: "https://www.meadowsweetmidwifery.com", description: "Home birth midwifery practice serving Denver and surrounding areas. Offering prenatal, birth, and postpartum care with a focus on empowering, enriching birth experiences.", isMidwife: true, costRange: "$6,500 (global fee)", serviceArea: ["Denver", "Lakewood", "Arvada", "Englewood"], services: ["Home Birth", "Prenatal Care", "Postpartum Care", "Lactation Support", "Water Birth"], acceptingClients: true },
      { name: "Sena Johnson", credential: "Registered Midwife (RM)", practice: "Birth Choice Association", url: "https://www.denvermidwife.com", description: "Denver's senior homebirth midwife with 38 years of experience and 1,100+ births attended. Offers holistic midwifery care including Craniosacral Therapy, Reiki, and herbal support.", isMidwife: true, costRange: "Contact for consultation", serviceArea: ["Denver", "Lakewood", "Arvada"], services: ["Home Birth", "Prenatal Care", "Postpartum Care", "Craniosacral Therapy", "Herbal Support", "Newborn Care"], acceptingClients: true },
    ],
    ...
    localDoulas: [
      {
        ...
        description: "Birth doula, Lamaze-certified childbirth educator, and DONA-approved birth doula trainer serving the greater Seattle area.",
        serviceArea: ["Seattle", "Ballard", "Wallingford", "Greenlake", "Edmonds", "Shoreline"],
        services: ["Birth Doula", "Childbirth Education", "DONA Training"],
      ...
      },
      {
        ...
        description: "Certified birth and postpartum doula with 18+ years of experience and 500+ families supported in the Seattle area.",
        costRange: "$3,400",
        serviceArea: ["Seattle"],
      ...
      },
      {
        ...
        description: "Postpartum doula and pediatric sleep consultant serving West Seattle and greater Seattle, with certifications from NAPS Doulas and the Sleep Counseling Institute.",

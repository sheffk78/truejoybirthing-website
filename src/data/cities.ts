...
export interface LocalDoula {
  ...
  /**
   * Stable unique identifier for this provider, e.g. "fremont-soul-sisters-doula-training-001".
   * Used as the link between cities.ts and the Google Sheet outreach tracker.
   * Pattern: {city-slug}-{name-slug}-{NNN}
   * Deterministic — does not change even if enrichment data changes.
   * Required for any provider that has been enriched or added to the Sheet.
   */
  id?: string;
  /**
   * Date (YYYY-MM-DD) when this provider was last enriched (data scraped, verified, added).
   * Used to prevent re-research: if enrichedAt is within 30 days, skip re-scraping.
...
export const cities: Record<string, CityData> = {
  ...
  "beaumont-tx": {
    ...
    localDoulas: [
      { name: "Krista Matlock", credential: "Certified Doula", practice: "Hygge Birth", url: "https://www.hyggebirth.com", photo: "/images/provider-beaumont-tx-krista-matlock.webp", description: "Certified birth and postpartum doula serving Beaumont and Southeast Texas families through Hygge Birth. Krista offers prenatal support, birth support, postpartum care, and private coaching with a focus on helping families feel informed and empowered throughout their journey.", services: ["Birth Doula", "Postpartum", "Prenatal Support", "Childbirth Education"], costRange: "$700\u2013$1,600", serviceArea: ["Beaumont", "Port Arthur", "Orange", "Southeast Texas"], acceptingClients: "Contact for availability" },
      { name: "Taylor Moonflower", credential: "Certified Nurse Midwife", practice: "Moonflower Midwifery", url: "", description: "Certified nurse-midwife serving Beaumont and Southeast Texas families through Moonflower Midwifery. Taylor provides personalized midwifery care, home birth support, and prenatal education with a focus on empowering families to make informed decisions about their birth experience.", services: ["Birth Doula", "Midwifery", "Prenatal Care", "Home Birth"], costRange: "$3,000\u2013$6,000", serviceArea: ["Beaumont", "Port Arthur", "Orange", "Southeast Texas"], acceptingClients: "Contact for availability" },
      { name: "Sacred Arrow Birth Services", credential: "Birth Doula", practice: "Sacred Arrow Birth Services", url: "", description: "Birth doula serving Beaumont and the Golden Triangle area with compassionate labor support, prenatal preparation, and postpartum care. Sacred Arrow Birth Services is committed to helping families feel informed, supported, and empowered throughout their birth journey.", services: ["Birth Doula", "Postpartum", "Prenatal Support"], costRange: "Contact for pricing", serviceArea: ["Beaumont", "Port Arthur", "Orange", "Southeast Texas"], acceptingClients: "Contact for availability" },
    ],
    culture: "Beaumont sits in the Golden Triangle of Southeast Texas, where families from Jefferson, Hardin, and Orange counties come for hospital births. The birth community is small but committed, anchored by two strong hospitals with verified Level III NICUs \u2014 Baptist Hospitals of Southeast Texas and CHRISTUS St. Elizabeth \u2014 giving families options most cities this size don\u2019t have. Families here tend to plan carefully, often traveling from rural areas into the city for delivery.",
    heroLocalDetail: "Families across the Golden Triangle \u2014 from Beaumont, Port Arthur, and Orange \u2014 deliver at CHRISTUS St. Elizabeth, where the L&D unit sees a steady volume of births from across the region. Baptist Hospitals of Southeast Texas on College Street also draws families from a wide area with its Level III NICU and New Beginnings Birth Center.",
    hospitalDetails: [
      { name: "Baptist Hospitals of Southeast Texas", thumbnail: "/images/baptist-beaumont.webp", url: "https://www.bhset.net", address: "3080 College St, Beaumont, TX 77701", nicuLevel: "III (stated directly on bhset.net)", paragraph: "Baptist Hospitals of Southeast Texas, at 3080 College St in Beaumont, has a verified Level III NICU with 16 beds, NICVIEW cameras for parents to check on their baby remotely, and experience with babies under 1 pound. Their New Beginnings Birth Center maternity unit includes 24/7 nurses, lactation support, and prenatal education. If you\u2019re delivering at Baptist, a birth plan helps the nursing team understand your preferences quickly, especially when the unit is busy. <a href=\"/birth-plan-template/\">Use our free hospital birth plan template</a> to get started." },
      { name: "CHRISTUS Southeast Texas \u2013 St. Elizabeth", thumbnail: "/images/christus-st-elizabeth.webp", url: "https://www.christushealth.org/christus-southeast-texas/st-elizabeth", address: "2830 Calder Ave, Beaumont, TX 77702", nicuLevel: "III (verified Level III NICU)", paragraph: "CHRISTUS Southeast Texas \u2013 St. Elizabeth, at 2830 Calder Ave in Beaumont, also has a verified Level III NICU with on-call neonatologists and maternal transport services, drawing families from across the Golden Triangle. CHRISTUS St. Elizabeth offers midwifery services (CNM) and is a Texas Ten Step facility \u2014 meaning they actively support breastfeeding families. Doulas are generally welcome \u2014 confirm visitor policy on your hospital tour. The St. Mary campus in Port Arthur provides additional emergency and specialty services." },
    ],
    ...
    birthCenterNote: "Birth Center of Beaumont, led by Jackie Griggs, CNM, is a freestanding birth center on Broadway offering midwife-led care for low-risk pregnancies in the Golden Triangle area. The center provides an alternative to hospital birth with personalized prenatal care, natural birth support, and breastfeeding assistance in a home-like setting.",
  ...
  "corpus-christi-tx": {
    ...
    lat: 32.7767,
    lng: -96.7970,
    ogImage: "https://truejoybirthing.com/images/og-city-dallas-tx-v3.webp",
    heroImage: "/images/dallas-tx-birth-doula-skyline-v2.webp",
    ...
    localDoulas: [
      ...
      { name: "Partum Health", photo: "/images/partum-health.webp", practice: "Partum Health Dallas", url: "https://www.partumhealth.com/care/dallas-texas-postpartum-doula", services: ["Postpartum", "Lactation"], serviceArea: ["Dallas", "DFW"], costRange: "$35\u2013$50/hour", acceptingClients: true, description: "Partum Health connects Dallas families with vetted postpartum doulas and lactation consultants." },
          { name: "Felicia Melton", practice: "Naturally Nestin", photo: "/images/felicia-melton.webp", url: "https://naturallynestin.com", services: ["Birth Doula", "Postpartum", "Childbirth Education", "Lactation Support"], serviceArea: ["Dallas", "DFW"], costRange: "$1,800-$3,500", acceptingClients: true, description: "DONA-trained birth and CAPPA-certified postpartum doula serving Dallas families." },
      { name: "LaJoi Carter", photo: "/images/lajoi-carter.webp", services: ["Birth Doula", "Postpartum"], serviceArea: ["Dallas"], costRange: "$1,000-$1,500", acceptingClients: true, description: "Birth and postpartum doula serving Dallas families." },
      { name: "Tianna Proctor", photo: "/images/tianna-proctor.webp", services: ["Birth Doula", "Postpartum"], serviceArea: ["Dallas"], costRange: "$1,200-$1,700", acceptingClients: true, description: "Birth doula offering compassionate labor support for Dallas families." },
      { name: "Samantha Clay", photo: "/images/samantha-clay.webp", services: ["Birth Doula", "Postpartum"], serviceArea: ["Dallas"], costRange: "$1,000-$1,500", acceptingClients: true, description: "Birth and postpartum doula providing continuous labor support." },
      { name: "Cortni Simon", photo: "/images/cortni-simon.webp", credential: "RN", services: ["Birth Doula", "Postpartum"], serviceArea: ["Dallas"], costRange: "$150-$1,500", acceptingClients: true, description: "Registered nurse and birth doula for Dallas families." },
    ],
    ...
    hospitalDetails: [
      { name: "Texas Health Presbyterian Hospital Dallas", thumbnail: "/images/texas-health-dallas.webp", address: "8200 Walnut Hill Ln, Dallas, TX 75231", url: "https://www.texashealth.org/womens", nicuLevel: "III", vbacPolicy: "Allows TOLAC/VBAC, consult with provider", doulaPolicy: "Doulas welcome as support persons", midwifeFriendly: true, waterBirth: "Hydrotherapy tubs not routinely available; water birth varies by provider", medicaid: true, lactation: true, privateRooms: true, paragraph: "Texas Health Presbyterian Hospital Dallas (8200 Walnut Hill Lane), the flagship of the Texas Health system, is a verified Level I Trauma Center with a high-volume L&D unit and a Level III NICU verified on texashealth.org. Doulas are generally welcome. If you\u2019re delivering at Texas Health Dallas, having your birth plan ready helps you navigate a busy hospital that serves a huge catchment area. <a href=\"/birth-plan-template/\">Use our free hospital birth plan template</a> to get started." },
      { name: "Baylor University Medical Center", thumbnail: "/images/baylor-dallas.webp", address: "3500 Gaston Ave, Dallas, TX 75246", url: "https://www.bswhealth.com/locations/baylor-university-medical-center", nicuLevel: "III", vbacPolicy: "Allows TOLAC/VBAC, consult with provider", doulaPolicy: "Doulas welcome as support persons", midwifeFriendly: true, waterBirth: "Hydrotherapy tubs not routinely available; water birth varies by provider", medicaid: true, lactation: true, privateRooms: true, paragraph: "Baylor University Medical Center (3500 Gaston Ave), part of Baylor Scott & White Health, draws families from across Dallas for its high-risk and maternal-fetal medicine programs with a Level III NICU. CNM-attended births are available through Baylor\u2019s midwifery program. If you\u2019re delivering at Baylor, having your birth plan ready makes everything smoother. <a href=\"/birth-plan-template/\">Use our free hospital birth plan template</a> to get started." },
      { name: "Parkland Memorial Hospital", thumbnail: "/images/parkland-memorial.webp", address: "5200 Harry Hines Blvd, Dallas, TX 75235", url: "https://www.parklandhealth.org/maternity", nicuLevel: "III", vbacPolicy: "Allows TOLAC/VBAC through maternal-fetal medicine program", doulaPolicy: "Doulas welcome as support persons; Parkland has an active doula program", midwifeFriendly: true, waterBirth: "Hydrotherapy and water birth options vary; contact hospital for current availability", medicaid: true, lactation: true, privateRooms: true, paragraph: "Parkland Memorial Hospital (5200 Harry Hines Blvd), Dallas County\u2019s public hospital and a Level I Trauma Center, handles one of the largest volumes of births in the entire state with a Level III NICU staffed by UT Southwestern faculty. Parkland has a well-known doula program and is used to working with doulas as part of the care team. If you\u2019re delivering at Parkland, having your birth plan ready helps in a high-volume setting. <a href=\"/birth-plan-template/\">Use our free hospital birth plan template</a> to get started." },
      { name: "Medical City Dallas", thumbnail: "/images/medcity-dallas.webp", address: "7777 Forest Ln, Dallas, TX 75230", url: "https://medicalcitydallas.com/services/maternity", nicuLevel: "III", vbacPolicy: "Allows TOLAC/VBAC, consult with provider", doulaPolicy: "Doulas welcome as support persons", midwifeFriendly: true, waterBirth: "Hydrotherapy tubs not routinely available; water birth not routinely offered", medicaid: true, lactation: true, privateRooms: true, paragraph: "Medical City Dallas (7777 Forest Ln), an 899-bed HCA Healthcare hospital, lists a Level III NICU, maternal-fetal care, and labor and delivery among its specialties. Doulas are generally welcome. The campus is off Forest Lane at I-635 and Central Expressway, making it accessible from across north Dallas. <a href=\"/birth-plan-template/\">Use our free hospital birth plan template</a> to get started." },
      { name: "Methodist Dallas Medical Center", thumbnail: "/images/methodist-dallas.webp", address: "1416 N Beckley Ave, Dallas, TX 75203", url: "https://www.methodisthealthsystem.org/locations/methodist-dallas-medical-center", nicuLevel: "III", vbacPolicy: "Allows TOLAC/VBAC, consult with provider", doulaPolicy: "Doulas welcome as support persons", midwifeFriendly: true, waterBirth: "Hydrotherapy not routinely available; water birth varies by provider", medicaid: true, lactation: true, privateRooms: true, paragraph: "Methodist Dallas Medical Center (1416 N Beckley Ave), part of the Methodist Health System, provides L&D services and maternity care for southern and central Dallas families with a Level III NICU. Doulas are generally welcome. If you\u2019re delivering at Methodist Dallas, having your birth plan ready makes everything smoother. <a href=\"/birth-plan-template/\">Use our free hospital birth plan template</a> to get started." },
    ],
    birthCenterDetails: [
      { name: "Urban Family Co-op Dallas (formerly Dallas Birth Center)", thumbnail: "/images/urban-family-coop.webp", address: "4218 Main St, Dallas, TX 75226", url: "https://dallasbirthcenter.com", paragraph: "Urban Family Co-op Dallas (4218 Main St in Deep Ellum), formerly known as Dallas Birth Center, is a freestanding birth center run by Licensed Midwife Kristine Tawater, offering midwife-led birth in a lower-intervention setting. Call 214-914-5015 or visit dallasbirthcenter.com to confirm current availability and schedule a tour. Medicaid accepted for eligible plans under SB 750." },
    ],
    ...
    insuranceNote: "Whether doula services are partially covered varies by plan in the DFW metro area. Check whether your plan covers out-of-network doula services, and whether HSA or FSA funds can help cover out-of-pocket costs.",
    faqs: [
      { q: "Does Medicaid cover doulas in Dallas?", a: "Yes! Great news \u2014 Medicaid covers doula services in Dallas. This is thanks to SB 750. That includes Dallas County\u2019s STAR managed care plans. Here\u2019s your next step: call your Medicaid plan and ask \"Do you cover doula services?\" \u2014 they\u2019ll walk you through it." },
      { q: "Which Dallas hospitals are birth-plan friendly?", a: "Texas Health Presbyterian Hospital Dallas, Baylor University Medical Center, Parkland Memorial Hospital, Medical City Dallas, and Methodist Dallas Medical Center all provide L&D services and generally accommodate birth plans, though policies vary by facility. <a href=\"/birth-plan-template/\">Grab the free birth plan template</a> so you walk in knowing exactly what you want." },
      { q: "How much does a doula cost in Dallas?", a: "Expect to pay $900 to $2,800 for a doula in Dallas. That's the DFW metro range — Dallas doulas typically charge between a few hundred dollars on the low end and close to three thousand for an experienced doula with extensive training. Most packages include 1–2 prenatal visits, continuous labor support, and 1–2 postpartum check-ins. DFW doula fees tend to run a bit higher than smaller Texas cities because the cost of living is higher, but the range also means there's a doula for nearly every budget. Check whether your health plan offers any doula benefits when you're comparing options. <a href=\"/birth-plan-template/\">Grab the free birth plan template</a> to start thinking about what matters most to you." },
      { q: "Do Dallas hospitals allow doulas during labor?", a: "Yes \u2014 Texas Health Dallas, Baylor, Parkland, Medical City Dallas, and Methodist Dallas all generally welcome doulas, though visitor policies can shift seasonally. Always confirm during your hospital tour." },
      { q: "Does True Joy Birthing work with Dallas families?", a: "Yes \u2014 and it\u2019s free. True Joy Birthing\u2019s birth plan app works for any Dallas birth setting. <a href=\"/birth-plan-template/\">Download the free birth plan template</a> and start preparing." },
    ],
...
"denton-tx": {
  ...
  "houston-tx": {
    ...
    faqs: [
      { q: "How much does a doula cost in Houston?", a: "Expect to pay $800 to $2,600 for a doula in Houston. That\'s the typical range across the Houston metro \u2014 doula fees here tend to be slightly lower than Dallas but higher than smaller Texas cities, reflecting the local cost of living. Most packages include 1\u20132 prenatal visits, continuous labor support through your entire birth, and 1\u20132 postpartum check-ins. Some Houston doulas offer payment plans or sliding-scale pricing, so don\'t hesitate to ask. And if you have an HSA or FSA, check whether your plan covers doula services \u2014 many families use those funds to help pay. <a href=\"/birth-plan-template/\">Grab the free birth plan template</a> to start thinking about what matters most to you." },
  ...
  "longview-tx": {
    ...
    lng: -96.6397,
    localDoulas: [
      { name: "Little Lilacs Birth Services", practice: "Little Lilac Birth Services", url: "https://littlelilacs.com", services: ["Birth Doula", "Postpartum", "Childbirth Education", "Lactation Support", "Placenta Encapsulation"], serviceArea: ["McKinney", "Dallas", "Plano", "Frisco", "DFW"], costRange: "$950\u2013$2,700", acceptingClients: true, photo: "/images/provider-mckinney-tx-little-lilacs.webp", description: "A DFW-area doula team serving McKinney families with birth doula support, postpartum care, childbirth education, lactation support, and placenta encapsulation — with doulas who cover Collin, Dallas, and Tarrant counties." },
      { name: "Amie Ivy Doula", practice: "Amie Ivy Doula", services: ["Birth Doula", "Postpartum"], serviceArea: ["McKinney", "Collin County"], costRange: "Contact for pricing", acceptingClients: true, description: "Independent birth and postpartum doula serving McKinney and Collin County families with personalized, evidence-based support and continuous care throughout labor and the early postpartum period." },
      { name: "Babymoon Concierge", practice: "Babymoon Concierge", url: "https://www.babymoonconcierge.com", services: ["Birth Doula", "Postpartum", "Childbirth Education"], serviceArea: ["McKinney", "Collin County", "DFW"], costRange: "Contact for pricing", acceptingClients: true, photo: "/images/provider-mckinney-tx-babymoon.webp", description: "A trusted DFW birth and postpartum agency founded in 2009, matching McKinney families with experienced birth doulas, postpartum doulas, newborn care specialists, and sleep training support." },
    ],
    culture: "McKinney is one of the fastest-growing cities in North Texas and the seat of Collin County, drawing young families with its historic downtown, top-rated schools, and suburban appeal. The Collin County birth community is active and growing fast \u2014 doula agencies like Little Lilacs are expanding their teams to keep up with demand, and families tend to plan ahead, tour both hospitals (BSW McKinney and Medical City McKinney), and book doulas early.",
    heroLocalDetail: "McKinney families delivering at Baylor Scott & White on Lake Forest Drive \u2014 US-75 construction has been a constant, and if you\u2019re coming from the west side of town, the detour routes add real time. Towne Lake\u2019s walking loop is where a lot of McKinney moms head for third-trimester evenings \u2014 the path around the lake is flat, well-lit, and close enough to both hospitals.",
    hospitalDetails: [
      { name: "Baylor Scott & White McKinney", thumbnail: "/images/bsw-mckinney.webp", paragraph: "Baylor Scott & White McKinney, in the US-75/Lake Forest area, has scaled up fast alongside the city\u2019s growth with a Level III NICU (contact the hospital directly for current level verification) and a strong obstetric program. <a href=\"/birth-plan-template/\">Use our free hospital birth plan template</a> to get started." },
      { name: "Medical City McKinney", thumbnail: "/images/medical-city-mckinney-v2.webp", paragraph: "Medical City McKinney, serving northern Collin County, has a NICU \u2014 contact the hospital directly for current NICU level verification \u2014 and a solid obstetric program. McKinney families are well-served by both hospitals." },
    ],
    birthCenterDetails: [
    ...
    faqs: [
      { q: "Does Medicaid cover doulas in McKinney?", a: "Yes! Great news \u2014 Medicaid covers doula services in McKinney. This is thanks to SB 750. That includes Collin County\u2019s STAR managed care plans." },
      { q: "Which hospitals in McKinney accommodate birth plans?", a: "Baylor Scott & White McKinney has a Level III NICU (contact the hospital directly for current level verification). Medical City McKinney also serves northern Collin County with a NICU. Always confirm policies during your tour." },
      { q: "How much does a doula cost in McKinney?", a: "Expect to pay $950 to $2,700 for a doula in McKinney. The investment typically covers prenatal visits, labor support, and postpartum check-ins. <a href=\"/birth-plan-template/\">Grab the free birth plan template</a> to get started." },
      { q: "Which hospital in McKinney is best for birth plans?", a: "Both BSW McKinney and Medical City McKinney serve the area well. Families in McKinney are well-served by both." },
      { q: "Does True Joy Birthing work with McKinney families?", a: "Yes \u2014 and it\u2019s free. The birth plan app works for any birth setting. <a href=\"/birth-plan-template/\">Download the free birth plan template</a> and start preparing." },
    ],
...
"odessa-tx": {
  ...
  "waco-tx": {
    ...
    heroImage: "/images/waco-tx-hero-v2.webp",
    ogImage: "https://truejoybirthing.com/images/og-city-waco-tx-v2.webp",
    supportSceneImage: "/images/waco-tx-birth-doula-support.webp",
    supportSceneAlt: "Two women walking side by side in Waco with the Dr Pepper Museum and Baylor campus in the distance",
    publishedDate: "2026-06-17",
    lat: 31.5493,
    lng: -97.1467,
    enableBlogResources: true,
    localDoulas: [
      { name: "Eryn Davidson", credential: "Birth Doula, CD(Carriage House Birth)", practice: "Eryn Davidson Doula Services", url: "http://eryndavidsondoula.com", description: "Birth doula serving Waco with 7 years of experience, certified through Carriage House Birth. Offers virtual consultations on choosing a provider, birth planning, advocacy training, and childbirth education.", services: ["Birth Doula", "Virtual Consultations", "Childbirth Education"], costRange: "Contact for pricing", serviceArea: ["Waco", "McLennan County"], photo: "/images/doulas/eryn-davidson.webp", acceptingClients: "Contact for availability" },
      { name: "Dannette McGrew", credential: "Birth Doula, CBD", practice: "Companion Birth Services", url: "https://www.companionbirthservices.com", description: "Birth doula and childbirth educator near Waco, certified in 2025 with a background in EMS. Passionate about physiological birth, offering Brewer Diet coaching, birth support, and breastfeeding support.", services: ["Birth Doula", "Childbirth Education", "Brewer Diet Coaching", "Breastfeeding Support"], costRange: "Contact for pricing", serviceArea: ["Waco", "McLennan County"], photo: "/images/doulas/dannette-mcgrew.webp", acceptingClients: "Contact for availability" },
      { name: "Victoria", credential: "Birth Doula, MaternityWise Certified", practice: "Barycenter Doula", url: "https://www.barycenter-doula.com", description: "Certified birth doula and placenta encapsulation specialist serving Waco, Killeen, Temple, and Gatesville. Provides calm, grounded support for hospital and home births.", services: ["Birth Doula", "Placenta Encapsulation"], costRange: "Contact for pricing", serviceArea: ["Waco", "Killeen", "Temple", "Gatesville"], photo: "/images/doulas/victoria-barycenter.webp", acceptingClients: "Contact for availability" },
      { name: "Abigail (Let\u2019s Doula This Waco)", credential: "Certified Full Spectrum Doula", practice: "Let\u2019s Doula This Waco", url: "https://www.letsdoulathiswaco.com", description: "Waco native and Certified Full Spectrum Doula specializing in fertility, birth, bereavement, and postpartum support. Also certified as a Placenta Encapsulation Specialist.", services: ["Birth Doula", "Full Spectrum Doula", "Placenta Encapsulation", "Childbirth Education"], costRange: "Contact for pricing", serviceArea: ["Waco", "McLennan County"], photo: "", acceptingClients: "Contact for availability" },
    ],
    midwifeInfo: {
    ...
    birthCenterDetails: [
      ...
      { name: "Waco Birth Center and Clinic", thumbnail: "/images/waco-birth-center.webp", paragraph: "Waco Birth Center and Clinic, on Austin Avenue near downtown, is a licensed freestanding birth center staffed by certified nurse-midwives. They accept insurance and Medicaid, making them one of the more accessible out-of-hospital birth options in Central Texas." },
    ],
  ...
  "midland-tx": {
    ...
    enableBlogResources: true,
    localDoulas: [
      { name: "Midland Doula Collective", credential: "Birth Doula Collective", practice: "Midland Doula Collective", url: "https://www.midlanddoulacollective.com", description: "A collective of experienced birth doulas serving Midland, Odessa, and the Permian Basin. Their team includes Joyce Stovall, Lindsey Coulter, Chrashae Wagner, Samantha Saville, Stephanie Kowacz, Sarah Catalino, and Jenny Townsend \u2014 offering birth doula support, postpartum care, childbirth education, and birth photography across West Texas.", services: ["Birth Doula", "Postpartum", "Childbirth Education", "Birth Photography"], costRange: "$800\u2013$2,000", serviceArea: ["Midland", "Odessa", "Andrews", "Seminole"], acceptingClients: "Contact for availability" },
      { name: "Nurture Me Birth Services", credential: "Birth Doula", practice: "Nurture Me Birth Services", url: "https://www.facebook.com/nurturemebirthservices/", description: "Birth doula serving Midland and the Permian Basin with personalized prenatal, labor, and postpartum support.", services: ["Birth Doula", "Postpartum"], serviceArea: ["Midland", "Odessa"], acceptingClients: "Contact for availability" },
    ],
    culture: "Midland sits in the heart of the Permian Basin, where the boom-and-bust rhythm of oil and gas shapes everything, including how families plan for birth. The doula community here is tight-knit by necessity \u2014 the Midland Doula Collective covers a huge geographic area from Andrews to Odessa \u2014 and The Birth Center of Midland gives families an out-of-hospital option most Texas cities this size don\u2019t have. Families here tend to be practical, resourceful, and connected to each other through the oil-field community.",
    heroLocalDetail: "Midland Memorial sits on Rosalind Redfern Grover Parkway off Loop 250 on the west side of town, and if you\u2019re heading to Odessa Regional Medical Center (ORMC) in Odessa you\u2019ll take I-20 east about 20 minutes \u2014 both hospitals are accessible, but I-20 between Midland and Odessa can back up during oil-field shift changes. Rock the Basin at Centennial Park is where a lot of Midland moms walk in the third trimester \u2014 flat, shaded, and close enough to both hospitals that you\u2019re not stranded if something picks up.",
    hospitalDetails: [
      { name: "Midland Memorial Hospital", thumbnail: "/images/midland-memorial-hospital.webp", paragraph: "Midland Memorial Hospital, at 400 Rosalind Redfern Grover Parkway, is the main labor and delivery hospital for Midland and much of the Permian Basin, with a Level II NICU and a full women\u2019s services program. If Midland Memorial is where you\u2019re planning to give birth, it helps to walk in already clear on your preferences, because a busy hospital admission is not the moment most moms want to explain everything from scratch. <a href=\"/birth-plan-template/\">Use our free hospital birth plan template</a> so your team has something simple and specific to work from." },
      { name: "Odessa Regional Medical Center", paragraph: "Odessa Regional Medical Center, about 20 minutes east in Odessa at 520 E 6th St, was founded as a women\u2019s and children\u2019s hospital and carries that legacy forward with a Level III NICU (contact the hospital directly for current level verification) and the Permian Basin\u2019s most established maternity program. If we\u2019re being real, Midland families who want a higher-level NICU or a more specialized maternity experience often end up here \u2014 the drive is short, and the L&D unit handles a high volume of births for the region." },
    ],
    // The Birth Center of Midland confirmed via website search (June 2026).
    birthCenterDetails: [
      { name: "The Birth Center of Midland", url: "https://www.midlandbirthcenter.com", paragraph: "The Birth Center of Midland is a freestanding, midwife-led birth center offering a lower-intervention setting for low-risk pregnancies. It\u2019s the only out-of-hospital birth center in the Permian Basin \u2014 and having a doula who knows the rhythm of that space makes the whole thing feel a lot less unknown." },
    ],
    ...
    nearbyCities: ["odessa-tx", "lubbock-tx"],
  },
  "mcallen-tx": {
    city: "McAllen",
    state: "TX",
  ...
  "college-station-tx": {
    ...
    enableBlogResources: true,
    localDoulas: [
      { name: "Mallory Villafuerte", credential: "Birth Doula", practice: "The Crunchy-ish Doula", url: "https://www.crunchydoula.com", photo: "/images/provider-tyler-tx-mallory-villafuerte.webp", services: ["Birth Doula", "Postpartum", "Childbirth Education"], serviceArea: ["Tyler", "Longview", "East Texas"], costRange: "$800\u2013$2,000", acceptingClients: true, description: "Evidence-based, faith-centered birth doula and childbirth educator serving Tyler and East Texas." },
      { name: "Kayley Hamilton", credential: "Birth Doula", practice: "Kayley Hamilton Doula", photo: "/images/provider-tyler-tx-kayley-hamilton.webp", services: ["Birth Doula", "Postpartum", "Prenatal Support"], serviceArea: ["Tyler", "East Texas"], costRange: "$800\u2013$2,000", acceptingClients: true, description: "Birth and postpartum doula in Tyler who nurtures the mother as a whole \u2014 spiritually, physically, and emotionally." },
      { name: "Camilla Morgan", credential: "Birth Doula", practice: "Camilla Morgan Doula", photo: "/images/provider-tyler-tx-camilla-morgan.webp", services: ["Birth Doula", "Postpartum", "Breastfeeding Support"], serviceArea: ["Tyler", "East Texas"], costRange: "$800\u2013$2,200", acceptingClients: true, description: "Birth and postpartum doula with 5 years of experience providing unwavering support through childbirth." },
      { name: "Tabitha Oogjen", credential: "Birth Doula", practice: "Mama Bare Doula LLC", photo: "/images/provider-tyler-tx-tabitha-oogjen.webp", services: ["Birth Doula", "Postpartum"], serviceArea: ["Tyler", "East Texas"], costRange: "$800\u2013$2,000", acceptingClients: true, description: "Certified birth doula serving East Texas families in hospital, birth center, and home settings." },
    ],
    ...
    birthCenterDetails: [
      { name: "Azalea Birth Center", thumbnail: "/images/azalea-birth-center-tyler.webp", paragraph: "Azalea Birth Center, on South Broadway in central Tyler, is a freestanding birth center run by midwife Vicky Wells, offering water birth and midwife-attended out-of-hospital birth in a home-like setting." },
    ],
    ...
    faqs: [
      ...
      { q: "Does Medicaid cover doulas in Tyler?", a: "Yes! Great news \u2014 Medicaid covers doula services in Tyler. This is thanks to SB 750. That includes Smith County\u2019s STAR managed care plans. Here\u2019s your next step: call your Medicaid plan and ask \"Do you cover doula services?\" \u2014 they\u2019ll walk you through it." },
      { q: "Which hospitals in Tyler accommodate birth plans?", a: "CHRISTUS Mother Frances Hospital \u2013 Tyler has a verified Level III NICU (the Lucy & John Carr NICU) and Level III Maternal designation, and UT Health Tyler earned its own Level III NICU designation in 2024. Tyler also has a freestanding birth center \u2014 Azalea Birth Center on South Broadway." },
      { q: "Does True Joy Birthing work with Tyler families?", a: "Yes \u2014 and it\u2019s free. True Joy Birthing\u2019s birth plan app, checklist, and guided walkthrough work for any Tyler birth setting. <a href=\"/birth-plan-template/\">Download the free birth plan template</a> and start preparing." },
    ],
    nearbyCities: ["dallas-tx", "longview-tx", "waco-tx"],
  },
"killeen-tx": {
    city: "Killeen",
    state: "TX",
    ...
    costHigh: 1800,
    shelbiServesHere: false,
    heroImage: "/images/killeen-tx-birth-doula-hero.webp",
    ogImage: "https://truejoybirthing.com/images/og-city-killeen-tx-v2.webp",
    supportSceneImage: "/images/killeen-tx-support-scene.webp",
    supportSceneAlt: "Two women walking side by side in a Killeen neighborhood near Fort Cavazos",
    enableBlogResources: true,
    publishedDate: "2026-06-17",
    lat: 31.1171,
    lng: -97.7278,
    localDoulas: [
      { name: "Tiesha Beasley", credential: "DONA Certified Birth Doula", practice: "Charmed Ones Doula Services", url: "https://www.hellomeela.com/listing/20576/", description: "DONA-certified birth doula serving Killeen and Fort Cavazos families with birth doula support, postpartum care, and lactation support. Tiesha is passionate about reducing racial disparities in maternal mortality and empowering families to advocate for themselves during birth.", services: ["Birth Doula", "Postpartum", "Lactation Support"], costRange: "$500", serviceArea: ["Killeen", "Fort Cavazos", "Harker Heights"], acceptingClients: true, photo: "" },
      { name: "Desiree Oliveri", credential: "DONA Certified Birth & Postpartum Doula", practice: "Soul Good Doulas", url: "https://www.soulgooddoulas.com/", description: "DONA-certified birth and postpartum doula with 15 years of experience serving Fort Cavazos, Killeen, and Central Texas families. Offers birth doula support, postpartum care, childbirth education, and virtual doula services through Soul Good Doulas.", services: ["Birth Doula", "Postpartum", "Childbirth Education", "Virtual Support"], costRange: "Contact for pricing", serviceArea: ["Killeen", "Fort Cavazos", "Temple", "Belton", "Central Texas"], acceptingClients: true, photo: "/images/doulas/killeen-tx-desiree-oliveri.webp" },
      { name: "Ashley Todd", credential: "Birth & Postpartum Doula", practice: "Heart of Texas Placental Services", url: "https://www.bornbir.com/ashley-todd", description: "Experienced birth and postpartum doula with 22 years of experience serving Killeen and Bell County families. Specializes in birth doula support, placenta encapsulation, breastfeeding support, and bereavement support. Also hosts the annual Big Latch On for Killeen.", services: ["Birth Doula", "Postpartum", "Placenta Encapsulation", "Breastfeeding Support", "Bereavement Support"], costRange: "Contact for pricing", serviceArea: ["Killeen", "Bell County", "Central Texas"], acceptingClients: true, photo: "/images/doulas/killeen-tx-ashley-todd.webp" },
      { name: "My Neighborhood Doula", credential: "Certified Birth Doula", practice: "My Neighborhood Doula", url: "https://myneighborhooddoula.com/", description: "Certified birth doula team serving Temple, Belton, Waco, Killeen, and surrounding Central Texas communities. Offers birth doula support, childbirth education classes, and postpartum care. Their $1,400 package includes prenatal visits, 24/7 on-call support, continuous labor support, and postpartum follow-up.", services: ["Birth Doula", "Childbirth Education", "Postpartum"], costRange: "$1,400", serviceArea: ["Temple", "Belton", "Waco", "Killeen", "Central Texas"], acceptingClients: true, photo: "/images/doulas/killeen-tx-my-neighborhood-doula.webp" },
    ],
    ...
    hospitalDetails: [
      { name: "AdventHealth Central Texas", thumbnail: "/images/adventhealth-central-texas.webp", paragraph: "AdventHealth Central Texas, on South Clear Creek Road in Killeen, is the city\u2019s only hospital with a labor and delivery unit \u2014 the J. Barry Siebenlist L&amp;D Unit, staffed by board-certified OB/GYNs and neonatologists. This is the hospital for Killeen proper: most Fort Cavazos families, Harker Heights residents, and south-Killeen neighborhoods deliver here by default because it\u2019s the closest option. AdventHealth keeps a smaller, quieter L&amp;D unit than the big Dallas or Temple hospitals \u2014 that can mean more attentive nursing, but also fewer on-site specialists for complications, so know your transfer route to BSW Temple just in case. <a href=\"/birth-plan-template/\">Use our free hospital birth plan template</a> to get started." },
      { name: "Baylor Scott & White Medical Center \u2013 Temple", thumbnail: "/images/baylor-scott-white-temple.webp", paragraph: "Baylor Scott & White in Temple, about 20 minutes north on I-35, is a large teaching hospital that serves the broader Killeen-Temple metro. If we\u2019re being real, many Killeen families deliver here by choice or referral \u2014 it\u2019s the biggest hospital in the region and handles more complicated pregnancies. Contact the hospital directly for current NICU and maternity service details." },
      { name: "Carl R. Darnall Army Medical Center", thumbnail: "/images/carl-darnall-army-medical-center.webp", paragraph: "Carl R. Darnall Army Medical Center on Fort Cavazos is the military hospital serving active-duty service members, retirees, and their families. If you\u2019re Tricare-eligible, Darnall is your primary option for prenatal care and delivery on post. Contact the hospital directly for current maternity services, NICU availability, and Tricare coverage details." },
    ],
  ...
  "round-rock-tx": {
    ...
    lat: 30.5083,
    lng: -97.6789,
    culture: "Round Rock is one of the fastest-growing cities in Williamson County, where Austin\u2019s tech boom has pushed families north into planned communities and new subdivisions. The birth landscape here is split between families who deliver at St. David\u2019s Round Rock \u2014 the busiest L&D unit in the county \u2014 and those who choose midwife-led care at The Natural Birthing Center. It\u2019s a young-family town where many parents are navigating birth far from their own support networks.",
    ...
    hospitalDetails: [
      { name: "St. David\u2019s Round Rock Medical Center", thumbnail: "/images/st-davids-round-rock.webp", paragraph: "St. David\u2019s Round Rock Medical Center, at 2400 Round Rock Ave, is the primary hospital for labor and delivery in Round Rock and one of the busiest L&D units in Williamson County. The hospital has a verified Level II NICU (intensive care for sick and premature infants), as listed on the St. David\u2019s HealthCare NICU specialties page, plus a full women\u2019s health program and Magnet\u00ae recognition for nursing excellence. With 209 beds and a Level II Trauma Center designation, St. David\u2019s Round Rock handles a high volume of births for the fast-growing northern Austin suburbs. If you\u2019re delivering here, bring your birth plan \u2014 this hospital sees a lot of families and moves fast, and having your preferences written down makes the intake conversation smoother when you\u2019re already in labor. <a href=\"/birth-plan-template/\">Use our free hospital birth plan template</a> to get started." },
    ],
    // The Natural Birthing Center confirmed via web search (June 2026).
    // NPI taxonomy 261QB0400X search: returned no additional results.
    birthCenterDetails: [
      { name: "The Natural Birthing Center", credential: "Birth Center", practice: "The Natural Birthing Center", url: "https://www.naturalbirthingcenter.net", description: "Freestanding birth center in Round Rock offering home birth, birth center, and water birth options with midwife-attended care. Located at 1101 Satellite View, Suite 104, Round Rock, TX 78665.", services: ["Birth Center", "Home Birth", "Water Birth", "Midwifery"], costRange: "$3,500\\u2013$6,000", medicaid: false },
    ],
    ...
    localDoulas: [
      { name: "Circle Birth", credential: "Birth Doula", practice: "Circle Birth", url: "https://www.circlebirth.com", description: "Professional doula agency serving Round Rock, Austin, and surrounding areas with birth doula support, postpartum doula care, and childbirth classes. Their team provides compassionate, personalized support for families delivering at St. David's Round Rock and other Williamson County hospitals.", services: ["Birth Doula", "Postpartum", "Childbirth Education"], costRange: "$800\\u2013$1,800", serviceArea: ["Round Rock", "Austin", "Cedar Park", "Georgetown", "Pflugerville", "Leander"], acceptingClients: true },
      { name: "Lacey Dowlearn", credential: "Certified Birth Doula (Birth Boot Camp)", practice: "Supporting Arms", url: "https://www.bornbir.com/lacey-dowlearn", description: "Birth Boot Camp certified childbirth educator and birth doula serving Round Rock and surrounding Central Texas communities. Offers comprehensive birth doula support and childbirth education classes to help families prepare with confidence.", services: ["Birth Doula", "Childbirth Education"], serviceArea: ["Round Rock", "Austin", "Cedar Park", "Georgetown"], acceptingClients: "Contact for availability" },
      { name: "Matriarch Doula Care", credential: "Birth Doula", practice: "Matriarch Doula Care", description: "Birth doula serving Round Rock families with prenatal, labor, and postpartum support in Williamson County including St. David's Round Rock Medical Center.", services: ["Birth Doula", "Postpartum"], serviceArea: ["Round Rock", "Cedar Park", "Pflugerville"] },
    ],
  ...
  "conroe-tx": {
    ...
    localDoulas: [
      ...
      { name: "Dia The Doula", credential: "Birth & Postpartum Doula", practice: "Lone Star Birth Christian Doula Network", url: "https://www.honeybook.com/widget/dia_the_doula_227346/cf_id/62ccf8dca1cfec2320a32f8e", description: "Christian birth and postpartum doula based in Cypress, TX with 12 years of birth doula experience and 120 births attended. Part of the Lone Star Birth Christian Doula Network. Offers faith-based support, flexible installment plans, and multiple discounts. Attends hospital, birth center, and home births. Offers acupressure, aromatherapy, hypnosis for birth, and TENS units.", services: ["Birth doula support", "Postpartum doula support", "Childbirth education", "Hypnosis for birth", "Placenta encapsulation", "Overnight postpartum support"], costRange: "$1,600 to $2,400", serviceArea: ["Cypress, TX (25-mile range, borderline Conroe)"], photo: "/images/provider-conroe-tx-dia-the-doula.webp", acceptingClients: true },
    ],
    ...
    hospitalDetails: [
      {
        ...
        thumbnail: "/images/hca-conroe.webp",
      },
    ],
    birthCenterDetails: [
      {
    ...
    nearbyCities: ["houston-tx", "the-woodlands-tx", "spring-tx", "college-station-tx"],
  },
  "sugar-land-tx": {
    city: "Sugar Land",
    state: "TX",
  ...
  "cary-nc": {
    ...
    midwifeInfo: {
      ...
      credentialTypes: " (CPM)",
      credentialDetail: "In North Carolina, CPMs are licensed through the NC Midwifery Joint Committee to attend out-of-hospital births, giving",
    },
    ...
    localDoulas: [
      { name: "Kelly Collins", photo: "/images/provider-cary-nc-kelly-collins.webp", credential: "ProDoula Certified Birth Doula, ProDoula Certified Postpartum", practice: "Best of Both Worlds Doula Services", url: "https://www.bestofbothworldsnc.com", description: "Experienced birth and postpartum doula serving the Triangle area with 11+ years and 81 births attended. Offers comprehensive support including childbirth education and lactation counseling.", costRange: "$1,500–$2,000", serviceArea: ["Cary", "Raleigh", "Durham", "Apex", "Chapel Hill"], services: ["Birth Doula", "Postpartum Doula", "Childbirth Education", "Lactation Support", "Virtual Doula"], acceptingClients: true },
      { name: "Debbie Swinson", photo: "/images/provider-cary-nc-debbie-swinson.webp", credential: "CD(DONA), PCD(DONA), CLC", practice: "Mommy's Way's Doula Services Agency, LLC", description: "Highly experienced DONA-certified doula with 22 years in practice serving the Triangle area. Certified birth and postpartum doula with lactation counselor credentials and 33 client testimonials.", costRange: "$1,500", serviceArea: ["Cary", "Raleigh", "Triangle area"], services: ["Birth Doula", "Postpartum Doula", "Lactation Support"], acceptingClients: true },
      { name: "Tara Flowers", photo: "/images/provider-cary-nc-tara-flowers.webp", credential: "CBD(AWWS)", practice: "Flowers Doula Services", description: "Certified birth doula with 7 years of experience serving the Triangle area. Known for providing compassionate, client-centered birth support.", costRange: "$1,200", serviceArea: ["Cary", "Raleigh", "Triangle area"], services: ["Birth Doula"], acceptingClients: true },
      { name: "Amanda Smith", photo: "", credential: "CD(DONA)", practice: "Hineni Birth and Beyond LLC", description: "DONA International certified birth doula offering both birth and postpartum support services to families in Cary and the Triangle.", costRange: "$1,200–$1,400", serviceArea: ["Cary", "Raleigh", "Triangle area"], services: ["Birth Doula", "Postpartum Doula"], acceptingClients: true },
      { name: "Kelly Rutan", photo: "/images/provider-cary-nc-kelly-rutan.webp", credential: "ProDoula Certified", practice: "Doulas of Raleigh", url: "https://www.doulasofraleigh.com", description: "Founder and co-owner of Doulas of Raleigh, a ProDoula-certified agency offering labor, postpartum, education, and placenta encapsulation services. Accepts Carrot, Maven, and Progeny workplace benefits.", costRange: "Contact for pricing", serviceArea: ["Cary", "Raleigh", "Durham", "Chapel Hill", "Triangle area"], services: ["Birth Doula", "Postpartum Doula", "Childbirth Education", "Placenta Encapsulation"], acceptingClients: true },
      { name: "Samantha", photo: "/images/provider-cary-nc-samantha.webp", credential: "Certified Birth Doula", practice: "Carolina Doula Collective", url: "https://www.carolinadoulacollective.com", description: "Founder of Carolina Doula Collective, providing a team-based approach with certified birth doula care, birth photography, placenta encapsulation, and hypnobirthing classes.", costRange: "Contact for pricing", serviceArea: ["Cary", "Raleigh", "Triangle area"], services: ["Birth Doula", "Postpartum Doula", "Birth Photography", "Placenta Encapsulation", "Hypnobirthing Classes"], acceptingClients: true },
      { name: "Kelly Collins", credential: "ProDoula Certified Birth Doula, ProDoula Certified Postpartum", practice: "Best of Both Worlds Doula Services", url: "https://www.bestofbothworldsnc.com", description: "Experienced birth and postpartum doula serving the Triangle area with 11+ years and 81 births attended. Offers comprehensive support including childbirth education and lactation counseling.", costRange: "$1,500–$2,000", serviceArea: ["Cary", "Raleigh", "Durham", "Apex", "Chapel Hill"], services: ["Birth Doula", "Postpartum Doula", "Childbirth Education", "Lactation Support", "Virtual Doula"], acceptingClients: true, photo: "/images/doulas/kelly-collins.webp" },
      { name: "Debbie Swinson", credential: "CD(DONA), PCD(DONA), CLC", practice: "Mommy's Way's Doula Services Agency, LLC", description: "Highly experienced DONA-certified doula with 22 years in practice serving the Triangle area. Certified birth and postpartum doula with lactation counselor credentials and 33 client testimonials.", costRange: "$1,500", serviceArea: ["Cary", "Raleigh", "Triangle area"], services: ["Birth Doula", "Postpartum Doula", "Lactation Support"], acceptingClients: true, photo: "/images/doulas/debbie-swinson.webp" },
      { name: "Tara Flowers", credential: "CBD(AWWS)", practice: "Flowers Doula Services", description: "Certified birth doula with 7 years of experience serving the Triangle area. Known for providing compassionate, client-centered birth support.", costRange: "$1,200", serviceArea: ["Cary", "Raleigh", "Triangle area"], services: ["Birth Doula"], acceptingClients: true, photo: "/images/doulas/tara-flowers.webp" },
      { name: "Amanda Smith", credential: "CD(DONA)", practice: "Hineni Birth and Beyond LLC", description: "DONA International certified birth doula offering both birth and postpartum support services to families in Cary and the Triangle.", costRange: "$1,200–$1,400", serviceArea: ["Cary", "Raleigh", "Triangle area"], services: ["Birth Doula", "Postpartum Doula"], acceptingClients: true, photo: "/images/doulas/amanda-smith.webp" },
      { name: "Kelly Rutan", credential: "ProDoula Certified", practice: "Doulas of Raleigh", url: "https://www.doulasofraleigh.com", description: "Founder and co-owner of Doulas of Raleigh, a ProDoula-certified agency offering labor, postpartum, education, and placenta encapsulation services. Accepts Carrot, Maven, and Progeny workplace benefits.", costRange: "Contact for pricing", serviceArea: ["Cary", "Raleigh", "Durham", "Chapel Hill", "Triangle area"], services: ["Birth Doula", "Postpartum Doula", "Childbirth Education", "Placenta Encapsulation"], acceptingClients: true, photo: "/images/doulas/kelly-rutan.webp" },
      { name: "Samantha", credential: "Certified Birth Doula", practice: "Carolina Doula Collective", url: "https://www.carolinadoulacollective.com", description: "Founder of Carolina Doula Collective, providing a team-based approach with certified birth doula care, birth photography, placenta encapsulation, and hypnobirthing classes.", costRange: "Contact for pricing", serviceArea: ["Cary", "Raleigh", "Triangle area"], services: ["Birth Doula", "Postpartum Doula", "Birth Photography", "Placenta Encapsulation", "Hypnobirthing Classes"], acceptingClients: true, photo: "/images/doulas/samantha-mcclellan.webp" },
  ...
  "tacoma-wa": {
    ...
    supportSceneImage: "/images/tacoma-support-scene.webp",
    hospitalDetails: [
      { name: "Tacoma General Hospital – MultiCare", address: "315 Martin Luther King Jr Way, Tacoma, WA 98405", thumbnail: "/images/tacoma-tacoma-general-hospital.webp", nicuLevel: "IV", vbacPolicy: "Allows TOLAC/VBAC", doulaPolicy: "Doulas welcome as support persons, integrated into TeamBirth process", midwifeFriendly: true, waterBirth: "Jetted tubs available in private birthing suites for hydrotherapy during labor", medicaid: true, lactation: true, privateRooms: true, url: "https://www.multicare.org/find-a-location/tacoma-general-hospital/departments/birth-center/", paragraph: "Pierce County's largest birth hospital with a full midwifery practice and private birthing suites, serving roughly 4,000 deliveries per year. The Family Birth Center offers all-private rooms with en suite bathrooms, jetted tubs, and sleeper sofas for overnight visitors. If your baby needs a higher level of care, the Level IV NICU at Mary Bridge Children's Hospital is adjacent and ready. Lactation consultants and an on-site lactation boutique are available. Tacoma General participates in TeamBirth, a shared decision-making process for a patient-centered experience. <a href=\"/birth-plan-template/\">Use our free hospital birth plan template</a> to prepare for your delivery here." },
      { name: "St. Joseph Medical Center – Virginia Mason Franciscan Health", address: "1717 South J Street, Tacoma, WA 98405", thumbnail: "/images/tacoma-st-joseph-hospital.webp", nicuLevel: "III", vbacPolicy: "Supports VBAC with collaborative midwifery and maternal-fetal medicine program", doulaPolicy: "Doulas welcome — certified professionals providing physical and emotional support", midwifeFriendly: true, waterBirth: "Waterbirth available; private bathroom with whirlpool tub in each suite for hydrotherapy during labor", medicaid: true, lactation: true, privateRooms: true, url: "https://www.vmfh.org/our-services/pregnancy-childbirth/labor-and-delivery/birth-centers/st-joseph-tacoma", paragraph: "A Level III NICU hospital on Tacoma's Hilltop offering maternal-fetal medicine, a collaborative midwifery program, and beautifully remodeled all-private birthing suites with city and mountain views. St. Joseph's supports VBAC, waterbirth, and has 24/7 OB hospitalists on-site. IBCLC-certified lactation consultants provide inpatient room visits and outpatient follow-up. The International Board of Lactation Consultant Examiners has recognized St. Joseph for excellence in lactation care. <a href=\"/birth-plan-template/\">Use our free hospital birth plan template</a> to prepare for your delivery here." },
      { name: "Good Samaritan Hospital – MultiCare (Puyallup)", address: "1802 E 39th Ave, Puyallup, WA 98372", thumbnail: "/images/tacoma-good-samaritan-hospital.webp", nicuLevel: "II", vbacPolicy: "Supports VBAC with 24/7 neonatology coverage", doulaPolicy: "Doulas welcome as support persons", midwifeFriendly: true, waterBirth: "Jetted tubs available in private birthing suites for hydrotherapy", medicaid: true, lactation: true, privateRooms: true, url: "https://www.multicare.org/find-a-location/good-samaritan-hospital/departments/birth-center/", paragraph: "Located just east of Tacoma in Puyallup, Good Sam features a Level II NICU with 24/7 coverage from board-certified neonatology specialists and a well-regarded midwifery-integrated birth unit. All rooms are private birthing suites with sleeping couches, rockers, jetted tubs, refrigerators, and wireless monitoring for laboring mobility. VBAC support, nitrous oxide for pain management, and lactation support are available. <a href=\"/birth-plan-template/\">Use our free hospital birth plan template</a> to prepare for your delivery here." }
    ],
    ...
    localDoulas: [
      ...
      { name: "Little Mitzvah Doula Care", isVerified: true, photo: "/images/provider-tacoma-wa-little-mitzvah.webp", credential: "Birth Doula, Pediatric Sleep Coach", practice: "Little Mitzvah Doula Care", url: "https://www.littlemitzvahdoulacare.com", description: "Birth doula and pediatric sleep coach supporting Tacoma families with compassionate support through birth and sleep training. Accepts Medicaid and Carrot fertility benefits.", costRange: "$2,400", serviceArea: ["Tacoma", "Fife", "Edgewood"], acceptsMedicaid: true, acceptingClients: true, services: ["Birth Doula", "Sleep Coaching"] },
      { name: "Katie Pumphrey", credential: "Birth Doula", practice: "MamaEarth Doula", url: "https://www.mamaearthdoula.com", description: "Tacoma-area doula serving families since 2012, specializing in empowering birth experiences across all settings — from out-of-hospital births to planned cesareans.", costRange: "$1,200–$3,000", serviceArea: ["Tacoma", "University Place", "Gig Harbor"], acceptsMedicaid: true, acceptingClients: true, services: ["Postpartum", "Breastfeeding Support", "Childbirth Education"], photo: "/images/doulas/katie-pumphrey.webp" },
      ...
      { name: "Adrianne Buyer", credential: "Birth Doula", practice: "Adrianne Buyer Birth Doula", url: "https://adriannebuyer.com", description: "Birth doula supporting Tacoma families through labor and early postpartum with a focus on breastfeeding and lactation support.", costRange: "$1,200–$2,500", serviceArea: ["Tacoma", "University Place", "Fircrest"], acceptsMedicaid: true, acceptingClients: true, services: ["Postpartum", "Lactation"], photo: "/images/doulas/adrianne-buyer.webp" },
      { name: "Kristin Lanning", credential: "Birth Doula, Postpartum Doula", practice: "Called To Birth Doulas & Birth Services", url: "https://www.calledtobirth.com", description: "Doula and childbirth educator providing birth doula support, postpartum care, and lactation guidance to Tacoma and South Sound families.", costRange: "$1,400–$3,000", serviceArea: ["Tacoma", "Puyallup", "Graham"], acceptsMedicaid: true, acceptingClients: true, services: ["Childbirth Education", "Lactation"], photo: "/images/doulas/kristin-lanning.webp" },
      { name: "Allie Wright", credential: "Birth Doula", practice: "Alma Birth Doula", url: "http://almabirthdoula.com", description: "Birth doula offering prenatal and postpartum support for families in the Tacoma area, helping them feel prepared and confident for their birth.", costRange: "$1,500–$2,800", serviceArea: ["Tacoma", "Gig Harbor", "Port Orchard"], acceptingClients: true, services: ["Postpartum", "Prenatal Care"], photo: "/images/doulas/allie-wright.webp" },
      { name: "Compass Doula & Lactation PLLC", credential: "Birth Doula, Lactation Consultant", practice: "Compass Doula & Lactation", url: "https://www.compassdoulas.com", description: "Doula and lactation support practice serving Tacoma families with compassionate, evidence-based care for birth, postpartum, and breastfeeding.", costRange: "$1,500–$3,500", serviceArea: ["Tacoma", "Lakewood", "Steilacoom"], acceptsMedicaid: true, acceptingClients: true, services: ["Postpartum", "Breastfeeding Support"], photo: "/images/doulas/compass-doulas-candace.webp" },
      { name: "Jennifer Ruggles", credential: "Birth Doula", practice: "Jennifer Ruggles Doula Services", url: "http://www.jennrugglesdoula.com", description: "Dedicated birth and postpartum doula serving Pierce County families with compassionate labor support and postpartum care.", costRange: "$1,200–$2,500", serviceArea: ["Tacoma", "Parkland", "Spanaway"], acceptsMedicaid: true, acceptingClients: true, services: ["Postpartum"], photo: "/images/doulas/jennifer-ruggles-headshot.webp" },
      { name: "Little Mitzvah Doula Care", credential: "Birth Doula, Postpartum Doula", practice: "Little Mitzvah Doula Care", url: "https://www.littlemitzvahdoulacare.com", description: "Overnight postpartum doula care for Tacoma families, offering newborn care, feeding support, and rest for new parents.", costRange: "$35–$50/hr", serviceArea: ["Tacoma", "Fife", "Edgewood"], acceptingClients: true, services: ["Overnight Care"], photo: "/images/doulas/little-mitzvah-melanie.webp" },
    ],
  ...
  "norfolk-va": {
    ...
    localDoulas: [
      ...
      { name: "Wholesome Hearts Doula Services", credential: "Birth Doula", practice: "Wholesome Hearts Doula Services", url: "https://www.facebook.com/WholesomeHeartsDoula", description: "Professional doula serving families in the area.", photo: "" },
      { name: "Leslie C. Cuffee ~ Doula and Placenta Encapsulation", credential: "Birth Doula", practice: "Leslie C. Cuffee ~ Doula and Placenta Encapsulation", url: "http://lesliecuffee.com", description: "Hi, I'm Leslie A doula, passionate about birth and empowering mothers through their pregnancy, labor and delivery.", services: ["Birth Doula", "Postpartum", "Placenta Encapsulation"], photo: "" },
      ...
      { name: "Laurie Ann's Postpartum Doula Services", credential: "Postpartum Doula", practice: "Laurie Ann's Postpartum Doula Services", url: "http://www.lafdoula.com", description: "Mothering the Mother in the Fourth Trimester — Laurie Ann Finn and Dani Tippett provide warm, experienced postpartum support for Norfolk families.", photo: "https://static.wixstatic.com/media/6c283f_32bc3440fc024f5393b0c5dc0111e0a5~mv2.jpg/v1/fill/w_434,h_323,al_c,q_80,usm_0.66_1.00_0.01,enc_avif,quality_auto/IMG_7277_edited.jpg", services: ["Postpartum", "Lactation", "Breastfeeding Support"], isVerified: false },
      { name: "Compass Birth Partners, LLC", isVerified: false, credential: "Birth Doula, Lactation Support", practice: "Compass Birth Partners, LLC", url: "https://rniesen.wordpress.com", description: "Compass Birth Partners, LLC — serving Virginia Beach, Norfolk, Chesapeake, VA and more with birth doula and lactation support.", photo: "https://rniesen.wordpress.com/wp-content/uploads/2022/11/dhpqobaprscnf1zpuv78ra_thumb_e.jpg", services: ["Birth Doula", "Lactation"] },
      ...
      { name: "Beautiful Bump Doula Services", credential: "Postpartum Doula", practice: "Beautiful Bump Doula Services", url: "https://theupcenter.org/programs/doula-services", description: "Extra support for expectant parents enrolled in Parents as Teachers Our Doula Services provide physical, emotional, and educational support during pregnancy, labor, and postpartum.", services: ["Postpartum", "Prenatal Care", "Evidence-Based Care"], acceptsMedicaid: true, photo: "" },
      { name: "Loving Births Doula by Devan", credential: "Birth Doula", practice: "Loving Births Doula by Devan", url: "https://www.lovingbirthsdoulabydevan.com/?utm_source=google&utm_medium=wix_google_business_profile&utm_campaign=11956095999040874463", description: "Connect it to your Wix website in just a few easy steps: 1.", photo: "" },
      { name: "All Nations Doula", credential: "Birth Doula", practice: "All Nations Doula", url: "http://allnationsdoula.com", description: "Serving Norfolk, Virginia Beach, Chesapeake, Portsmouth, Suffolk.", photo: "http://allnationsdoula.com/wordpress/wp-content/uploads/2018/02/Casey-Medrano-Doula.jpg", services: [] },
      ...
      { name: "Queendomdoulacare", credential: "Birth Doula", practice: "Queendomdoulacare", url: "https://www.honeybook.com/widget/a_sacred_spacefor_queens_196077/cf_id/61488f6647bc4f00343a2c0e", description: "Select an option How did you hear about us.", photo: "" },
      ...
      { name: "Christina Rutledge IBCLC, Doula - A Mother's Journey, LLC", credential: "Birth Doula, Lactation Support", practice: "Christina Rutledge IBCLC, Doula - A Mother's Journey, LLC", url: "http://www.amothersjourneyllc.com", description: "The Help You Deserve providing love and support from pregnancy to postpartum and everything in between Client Portal Request appointment Offers Telehealth Appointments Accepts Online Payments Accepts Insurance Accepting New Clients.", services: ["Birth Doula", "Postpartum", "Lactation", "Breastfeeding Support", "Childbirth Education"], photo: "" },
      ...
      { name: "Sentara Midwifery Specialists", credential: "LM, CPM", practice: "Sentara Midwifery Specialists", url: "https://www.sentara.com/hospitalslocations/sentara-midwifery-specialists/locations/sentara-midwifery-specialists-hampton", description: "Hospital-based midwifery care at Sentara, offering prenatal, birth, and postpartum support for Norfolk families.", photo: "", isMidwife: true },
  ...
  "fremont-ca": {
    ...
    hospitalDetails: [
      { name: "Washington Hospital", thumbnail: "/images/fremont-ca-washington-hospital.webp", paragraph: "Washington Hospital in Fremont is a community hospital with a full maternity unit featuring a Special Care Nursery for babies who need extra support. Labor and delivery has 24/7 OB hospitalist coverage — meaning a doctor is in-house at all times. Doulas are welcome, and the unit's midsize feel (around 2,000 births per year) means more personalized attention than the huge Stanford or UCSF units. If you're delivering here, having your birth plan ready makes everything smoother. <a href=\"/birth-plan-template/\">Use our free hospital birth plan template</a> to get started.", url: "https://www.whhs.com", address: "2000 Mowry Ave, Fremont, CA 94538", nicuLevel: "II" },
      { name: "Washington Hospital", thumbnail: "/images/washington-hospital-fremont.webp", paragraph: "Washington Hospital in Fremont is a community hospital with a full maternity unit featuring a Special Care Nursery for babies who need extra support. Labor and delivery has 24/7 OB hospitalist coverage — meaning a doctor is in-house at all times. Doulas are welcome, and the unit's midsize feel (around 2,000 births per year) means more personalized attention than the huge Stanford or UCSF units. If you're delivering here, having your birth plan ready makes everything smoother. <a href=\"/birth-plan-template/\">Use our free hospital birth plan template</a> to get started.", url: "https://www.whhs.com", address: "2000 Mowry Ave, Fremont, CA 94538", nicuLevel: "II" },
...
{ name: "Marcy Hogan Postpartum Doula", credential: "Postpartum Doula", practice: "Marcy Hogan Postpartum Doula", url: "https://www.marcythedoula.com", description: "Postpartum doula soothing babies and empowering parents in the SF Bay Area.", photo: "https://images.squarespace-cdn.com/content/v1/69d2c8eaa4854e48eb6c210e/3d19354e-34f6-4226-8b32-09cd760f66d5/2011+01+16-63.jpg", costRange: "$25-$45/hr; $125 consultation",
    services: ["Postpartum"] },
...
{ name: "Amelia Protiva, Birth Doula & Photographer", credential: "Postpartum Doula", practice: "Amelia Protiva, Birth Doula & Photographer", url: "http://ameliaprotiva.com", description: "Doula care rooted in rural Missouri.", photo: "https://images.squarespace-cdn.com/content/v1/691217c649987466a21cc93a/9d3811ec-de57-4091-b3e6-79a27adbb41a/Birth+Becomes+Her%E2%80%93Lukas_0011.jpg", costRange: "Contact for pricing",
    ...
    acceptingClients: false, },
      ...
      { name: "Postpartum Night Doula, Lactation, Infant Sleep", credential: "Postpartum Doula", practice: "Postpartum Night Doula, Lactation, Infant Sleep", url: "https://www.doulababyservices.com/?utm_source=google&utm_medium=wix_google_business_profile&utm_campaign=10469208935520663533", description: "Doula Baby Services: Supporting Your Parenting Journey Postpartum Doula Karina Plotek of DoulaBabyServices brings her warmth and expertise to the field of Postpartum Support, Newborn Care, Lactation Education & Pediatric Sleep Consulting.", photo: "https://static.wixstatic.com/media/b8ad51_902128a025114677a2f20611335d371d~mv2.jpg/v1/fill/w_668,h_439,al_c,q_80,usm_0.66_1.00_0.01,enc_avif,quality_auto/Mother%2520with%2520her%2520Child_edited.jpg", services: ["Postpartum", "Lactation"], costRange: "$1,500–$3,000" },
      { name: "Harmony Doula Group", credential: "Birth Doula, Lactation Support", practice: "Harmony Doula Group", url: "https://harmonydoula.com", description: "Childbirth and Lactation Education Calm.", photo: "https://harmonydoula.com/JQuery/imageJQR-1.jpg", services: ["Birth Doula", "Postpartum", "Lactation", "Placenta Encapsulation", "Childbirth Education"], costRange: "$1,500–$3,000" },
      { name: "Postpartum Doula Services by Tamra", credential: "Birth Doula, Lactation Support", practice: "Postpartum Doula Services by Tamra", url: "http://doulatamra.com", description: "jpg 9A8E282C-DCE1-4747-B5AD-7F74EB90A158.", photo: "https://images.squarespace-cdn.com/content/v1/5c6a0507d86cc95a5ae670e4/1550552173281-A9TIN9IW6NQE1Q4MGALK/IMG_1662.jpg", services: ["Birth Doula", "Postpartum", "Lactation", "Breastfeeding Support", "Overnight Care"], acceptsMedicaid: true, costRange: "$1,500–$3,000" },
      ...
      { name: "DOULAS by the BAY LLC", credential: "Birth Doula, Lactation Support", practice: "DOULAS by the BAY LLC", url: "https://www.doulasbythebay.com/discovery", description: "Evidence-Based Birth & Postpartum Doula Care in California Trusted since 2009 • 70+ employed doulas • 3,000+ families supported.", photo: "https://www.doulasbythebay.com/wp-content/uploads/2026/05/Kaiser-2.png", services: ["Birth Doula", "Postpartum", "Lactation", "Breastfeeding Support", "Overnight Care"], acceptsMedicaid: true, costRange: "$1,500–$3,000" },
      { name: "Quetzal Doula", credential: "Birth Doula", practice: "Quetzal Doula", url: "https://www.quetzaldoula.com", description: "cropped-quetzal-logo-e1496453396220.", photo: "https://quetzaldoula.com/wp-content/uploads/2017/02/rio-guacimal.jpg", services: ["Birth Doula", "Postpartum"], costRange: "$1,500–$3,000" },
      { name: "Stephanie Mollinier | Birth Doula", credential: "Birth Doula", practice: "Stephanie Mollinier | Birth Doula", url: "http://www.stephaniedoula.com", description: "jpg Birth Doula + Pregnancy Coaching for GROWING families in San Jose, CA Find the right doula support for you.", photo: "https://images.squarespace-cdn.com/content/v1/5b3eee9d2714e53cdf0ddea8/0bab41b0-f533-4e41-9e94-bf41deeece66/StephanieHeadshotSession5557-Edit.jpg", services: ["Birth Doula"], costRange: "$1,500–$3,000" },
      { name: "Bay City Doulas", credential: "Postpartum Doula", practice: "Bay City Doulas", url: "https://baycitydoulas.com", description: "Bay Area Postpartum Doulas BOOK A DISCOVERY CALL.", photo: "https://baycitydoulas.com/wp-content/uploads/2021/10/Welcome-Bay-city.png", services: ["Postpartum", "Breastfeeding Support", "Overnight Care"], costRange: "$1,500–$3,000" },
      { name: "Lauren Noble, Doula", credential: "Birth Doula", practice: "Lauren Noble, Doula", url: "http://nobledoula.com", description: "Thanks so much for coming I’m no longer taking doula clients.", photo: "https://images.squarespace-cdn.com/content/v1/55d5524ee4b03efa6b0a7cb8/2e25a290-ee20-4b9e-9793-737b8faca318/Violet+%26+Charlotte.JPEG", services: ["Birth Doula", "Postpartum", "Placenta Encapsulation", "Childbirth Education", "Prenatal Care"], costRange: "$1,500–$3,000" },
      // Removed 2026-06-09: Doula Studios is a hardware product development company, not a doula practice.
      { name: "Bay Area Night Doulas Collective", credential: "Postpartum Doula", practice: "Bay Area Night Doulas Collective", url: "https://bayareanightdoulas.com", description: "San Francisco Bay Area Postpartum Doulas Rest & Recover Say goodbye to sleepless nights Rest, recover, and bond with your new baby while our doulas take care of the rest.", photo: "https://bayareanightdoulas.com/wp-content/uploads/2023/03/yelp-logo.png", services: ["Postpartum", "Lactation", "Breastfeeding Support", "Overnight Care"], costRange: "$1,500–$3,000" },
      { name: "Plumeria Doula Care", credential: "Birth Doula", practice: "Plumeria Doula Care", url: "https://plumeriadoula.com", description: "Serving the San Francisco Bay Area ABOUT.", photo: "https://plumeriadoula.com/wp-content/uploads/2023/11/Leticia-Plumeria-Newborn-Care-min.png", services: ["Birth Doula", "Postpartum", "Breastfeeding Support"], costRange: "$1,500–$3,000" },
      ...
      { name: "Do Well Doula", credential: "Birth Doula", practice: "Do Well Doula", url: "http://www.dowelldoula.com", description: "CHILDBIRTH EDUCATION PREPARE As a former teacher, I'm big on empowering you with education.", photo: "https://static.wixstatic.com/media/13a2c5_8fa6f3822adc4684a08b0c3ff33180c2~mv2.jpg/v1/fill/w_374,h_374,al_c,q_80,usm_0.66_1.00_0.01,enc_avif,quality_auto/IMG_3296_edited.jpg", services: ["Birth Doula", "Postpartum", "Breastfeeding Support", "Childbirth Education", "Overnight Care"], costRange: "$1,500–$3,000" },
      { name: "East Bay Postpartum Doula Circle", credential: "Birth Doula, Lactation Support", practice: "East Bay Postpartum Doula Circle", url: "https://www.eastbaypostpartum.com", description: "Your Fourth Trimester, Covered A guild of 30+ certified doulas providing daytime, nighttime, and live-in postpartum care to Bay Area families.", photo: "https://eastbaypostpartum.com/images/doulas/denise-macko.jpg", services: ["Birth Doula", "Postpartum", "Lactation", "Breastfeeding Support", "Overnight Care"], acceptsMedicaid: true, costRange: "$1,500–$3,000" },
      { name: "Golden Gate Doula Associates", credential: "Birth Doula, Lactation Support", practice: "Golden Gate Doula Associates", url: "http://www.goldengatedoula.com", description: "meet Jennifer VIEW OUR doula SERVICES The Golden Gate Doula Associates was founded in 2016 by Jennifer Darwin and has quickly become a trusted resource for all your maternity and postpartum needs.", photo: "https://static.showit.co/400/oHWMuB6lQLuiM5O9wnczhg/shared/best_doula_2022.png", services: ["Birth Doula", "Postpartum", "Lactation", "Breastfeeding Support", "Prenatal Care"], costRange: "$1,500–$3,000" },
      { name: "Mama Bear Birth Services: Pre/Postnatal Pilates, Doula Support & Childbirth Education", credential: "Postpartum Doula", practice: "Mama Bear Birth Services: Pre/Postnatal Pilates, Doula Support & Childbirth Education", url: "https://sites.google.com/view/sfbirthservices/home", description: "Copy heading link Mama Bear Birth Services.", services: ["Postpartum", "Childbirth Education", "Prenatal Care"], costRange: "$1,500–$3,000" },
      { name: "The Dream Doula", credential: "Birth Doula", practice: "The Dream Doula", url: "http://thedreamdoula.me", description: "The support you and your family need to feel confident and reassured.", photo: "https://static.wixstatic.com/media/3024e3_4a8837886f3e4692963fe8dc7d0a57b5~mv2.jpg/v1/fill/w_615,h_737,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/3024e3_4a8837886f3e4692963fe8dc7d0a57b5~mv2.jpg", services: ["Birth Doula", "Postpartum", "Breastfeeding Support"], costRange: "$1,500–$3,000" },
      { name: "Sacred Lotus Doula Services", credential: "Birth Doula, Lactation Support", practice: "Sacred Lotus Doula Services", url: "https://www.yelp.com/biz/sacred-lotus-doula-services-dublin", description: "Photos & videos See all 20 photos Sacred Lotus Doula Services - I am certified through Stillbirthday as a birth and bereavement doula.", photo: "https://s3-media0.fl.yelpcdn.com/bphoto/YDWG6jhA9ZN-EW2sL4spBw/l.jpg", services: ["Birth Doula", "Postpartum", "Lactation", "Breastfeeding Support", "Placenta Encapsulation"], acceptsMedicaid: true, costRange: "$1,500–$3,000" },
      { name: "Modesto Birth & Beyond Doula Team - Made for Birth & Beyond Education", credential: "Birth Doula, Lactation Support", practice: "Modesto Birth & Beyond Doula Team - Made for Birth & Beyond Education", url: "https://www.modestobirthandbeyond.com", description: "MBB partners with Kaiser & HealthNet, offering 100% coverage for Education & Birth Plan Counseling, with or without birth doula or lactation support.", photo: "https://images.squarespace-cdn.com/content/v1/5d912c67bcf2f2691dc523de/1578258023513-HWHHZHD6OS4T1441W0Q6/IMG_8398.jpeg", services: ["Birth Doula", "Postpartum", "Lactation", "Breastfeeding Support", "Placenta Encapsulation"], acceptsMedicaid: true, costRange: "$1,500–$3,000" },
      { name: "San Mateo Doula", credential: "Postpartum Doula", practice: "San Mateo Doula", url: "https://sanmateodoula.com", description: "At San Mateo Doula With over 20 years of experience serving families in San Mateo County and the greater Bay Area, we provide expert, nurturing support at every stage of your birth and postpartum journey.", photo: "https://sanmateodoula.com/wp-content/uploads/2025/01/464293214_8493287680791970_1990419347808526617_n.jpg", services: ["Postpartum", "Breastfeeding Support", "Overnight Care"], costRange: "$1,500–$3,000" },
      { name: "Postpartum Doula & Parent Coach", credential: "Postpartum Doula", practice: "Postpartum Doula & Parent Coach", url: "https://www.doulababyservices.com", description: "Doula Baby Services: Supporting Your Parenting Journey Postpartum Doula Karina Plotek of DoulaBabyServices brings her warmth and expertise to the field of Postpartum Support, Newborn Care, Lactation Education & Pediatric Sleep Consulting.", photo: "https://static.wixstatic.com/media/b8ad51_902128a025114677a2f20611335d371d~mv2.jpg/v1/fill/w_668,h_439,al_c,q_80,usm_0.66_1.00_0.01,enc_avif,quality_auto/Mother%2520with%2520her%2520Child_edited.jpg", services: ["Postpartum", "Lactation"], costRange: "$1,500–$3,000" },
      { name: "Andrea Berkey; Three Phases Doula", credential: "Postpartum Doula", practice: "Andrea Berkey; Three Phases Doula", url: "http://www.threephasesdoula.com", description: "The whisperer of babies, your extra set of hands, and your resource center.", photo: "https://static.wixstatic.com/media/bf3444_d10d21d930b042c18bf5d7fa353c8b98.jpg/v1/crop/x_0,y_318,w_5760,h_3411/fill/w_979,h_805,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/bf3444_d10d21d930b042c18bf5d7fa353c8b98.jpg", services: ["Postpartum", "Lactation", "Breastfeeding Support"], costRange: "$1,500–$3,000" },
      { name: "Haven Baby Doula", credential: "Birth Doula, Lactation Support", practice: "Haven Baby Doula", url: "https://www.havenbabydoula.com", description: "Welcome, I'm Ruth Nuñez a birth and postpartum Doula from Palo Alto, CA.", photo: "https://cdn.prod.website-files.com/63ee95d877371e4e98b743f6/6409224a5b28263290578089_websittehold.jpg", services: ["Birth Doula", "Postpartum", "Lactation", "Home Birth", "Evidence-Based Care"], costRange: "$1,500–$3,000" },
      { name: "Nebula Doulas", credential: "Postpartum Doula", practice: "Nebula Doulas", url: "https://www.nebuladoulaservices.com", description: "Who We Are At Nebula, we specialize in Postpartum and Newborn Care.", photo: "https://static.wixstatic.com/media/01c3aff52f2a4dffa526d7a9843d46ea.png/v1/fill/w_25,h_25,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/01c3aff52f2a4dffa526d7a9843d46ea.png", services: ["Postpartum"], costRange: "$1,500–$3,000" },
      { name: "Trinity Night Doulas", credential: "Birth Doula", practice: "Trinity Night Doulas", url: "http://trinitynightdoulas.com", description: "Professional doula serving families in the area.", costRange: "$1,500–$3,000" },
      { name: "Bay Area Doula Training", credential: "Birth Doula, Lactation Support", practice: "Bay Area Doula Training", url: "https://bayareadoula.com/bay-area-doula-training", description: "Bay Area Doula Training Community-driven, evidence-based, trauma-informed, and coaching-oriented—delivering intentional, strategic birth support.", services: ["Birth Doula", "Postpartum", "Lactation", "Breastfeeding Support", "Childbirth Education"], acceptsMedicaid: true, costRange: "$1,500–$3,000" },
      { name: "Marcy Hogan Postpartum Doula", credential: "Postpartum Doula", practice: "Marcy Hogan Postpartum Doula", url: "https://www.marcythedoula.com", description: "Postpartum Doula Soothing babies & empowering parents in the SF Bay Area Book a Free Consult Services & Rates A sleeping baby lying on a person's chest, gripping the person's finger, in a hospital setting, in black and white.", photo: "https://images.squarespace-cdn.com/content/v1/69d2c8eaa4854e48eb6c210e/3d19354e-34f6-4226-8b32-09cd760f66d5/2011+01+16-63.jpg", services: ["Postpartum"], costRange: "$1,500–$3,000" },
      { name: "Pamela Lopes Doula", credential: "Birth Doula", practice: "Pamela Lopes Doula", url: "http://www.pamelalopesdoula.com", description: "Connect it to your Wix website in just a few easy steps: 1.", costRange: "$1,500–$3,000" },
      { name: "Amelia Protiva, Birth Doula & Photographer", credential: "Postpartum Doula", practice: "Amelia Protiva, Birth Doula & Photographer", url: "http://ameliaprotiva.com", description: "Doula care rooted in rural Missouri.", photo: "https://images.squarespace-cdn.com/content/v1/691217c649987466a21cc93a/9d3811ec-de57-4091-b3e6-79a27adbb41a/Birth+Becomes+Her%E2%80%93Lukas_0011.jpg", services: ["Postpartum"], costRange: "$1,500–$3,000" },
],
  ...
  "vancouver-wa": {
    ...
    hospitalDetails: [
      { name: "PeaceHealth Southwest Medical Center", thumbnail: "/images/peacehealth-southwest.webp", address: "400 NE Mother Joseph Pl, Vancouver, WA 98664", url: "https://www.peacehealth.org/locations/southwest-medical-center/maternity-services", nicuLevel: "III", vbacPolicy: "Allows TOLAC/VBAC, consult with provider for specific criteria", doulaPolicy: "Doulas welcome as support persons, confirm current policies during hospital tour", midwifeFriendly: true, waterBirth: "Labor tubs not routinely available; water birth not offered per hospital policy", medicaid: true, lactation: true, privateRooms: true, paragraph: "PeaceHealth Southwest Medical Center is a 450-bed community hospital with the Holtzman Twins Neonatal Intensive Care Unit and the second-busiest obstetrics unit in the Portland metropolitan area. With around 3,000 births per year, the Family Birth Center handles a high volume and is used to working with doulas. Doulas are generally welcome \u2014 confirm current policies during your hospital tour. If you\u2019re delivering at PeaceHealth, having your birth plan ready makes everything smoother. <a href=\"/birth-plan-template/\">Use our free hospital birth plan template</a> to get started." },
      { name: "Legacy Salmon Creek Medical Center", thumbnail: "/images/legacy-salmon-creek.webp", address: "2211 NE 139th St, Vancouver, WA 98686", url: "https://www.legacyhealth.org/locations/salmon-creek-medical-center/services/maternity", nicuLevel: "III", vbacPolicy: "Allows TOLAC/VBAC, discuss with provider", doulaPolicy: "Doulas welcome as support persons", midwifeFriendly: true, waterBirth: "Hydrotherapy not routinely available; water birth not offered", medicaid: true, lactation: true, privateRooms: true, paragraph: "Legacy Salmon Creek Medical Center, also in Vancouver, opened in 2005 and offers a birthing center with a neonatal intensive care unit and a dedicated children's-only emergency room. Families on the north side of Vancouver often find Legacy Salmon Creek more convenient, especially those living near I-205. Doulas are welcome, and the facility has a more modern feel than PeaceHealth's older campus." }
    ],
    ...
    localDoulas: [
      { name: "Suwannee Doula and Infant Care", credential: "Postpartum Doula", practice: "Suwannee Doula and Infant Care", url: "http://suwanneedoulacare.com", description: "Postpartum and overnight doula care serving Vancouver families. Specializing in breastfeeding support and overnight newborn care.", photo: "https://img1.wsimg.com/isteam/ip/850a11fe-671e-4c7f-8194-598ca4291beb/blob-3055cb9.png", services: ["Postpartum", "Breastfeeding Support", "Overnight Care"], costRange: "Contact for pricing" },
      { name: "EnCourage Doula Care LLC", credential: "Birth Doula", practice: "EnCourage Doula Care LLC", url: "https://www.encouragedoulacare.com", description: "Birth and bereavement doula serving Vancouver and Portland metro families. Offering childbirth education, breastfeeding support, and prenatal care.", photo: "https://static.wixstatic.com/media/692a5c_3a7fd8756b55414bbff5b3e0758243b0~mv2.jpg/v1/fill/w_189,h_216,al_c,q_80,usm_0.66_1.00_0.01,enc_avif,quality_auto/headshot%202024.jpg", services: ["Birth Doula", "Postpartum", "Breastfeeding Support", "Childbirth Education", "Prenatal Care"], costRange: "$2400–$2700", acceptsMedicaid: true },
      { name: "Heather Ward Birth Doula", credential: "Birth Doula", practice: "BirthLore", url: "http://www.birthlore.com", description: "Experienced birth and postpartum doula offering breastfeeding support and prenatal education for Vancouver families.", photo: "https://birthlore.com/wp-content/uploads/2023/06/IMG_1121.jpg", services: ["Breastfeeding Support", "Prenatal Care"], costRange: "Contact for pricing" },
      { name: "Birth First Doulas Portland", credential: "Birth Doula", practice: "Birth First Doulas Portland", url: "https://www.birthfirstdoulas.com/?utm_source=GMB&utm_medium=organic&utm_campaign=local", description: "Doula matching service connecting Portland-Vancouver families with experienced birth doulas, postpartum doulas, and educators.", photo: "https://birthfirstdoulas.com/wp-content/uploads/2019/10/portland-doula-pregnant-woman.jpg", services: ["Birth Doula", "Postpartum", "Breastfeeding Support", "Placenta Encapsulation", "Overnight Care"], acceptsMedicaid: true, costRange: "Contact for pricing" },
      { name: "Rachel J Gathright Doula Birth - Postpartum - Placenta", credential: "Birth Doula", practice: "Rachel J Gathright Doula Birth - Postpartum - Placenta", url: "http://racheljgathright.com", description: "Birth doula, postpartum support, and placenta services for Portland-Vancouver families. Helping you feel prepared and supported.", photo: "https://images.squarespace-cdn.com/content/v1/61f2f2124d792a3258a2c20f/350a816b-636e-46b5-a39e-c59d4e135a47/RachelYellow.jpg", costRange: "Contact for pricing" },
      { name: "Doula Love", credential: "Postpartum Doula", practice: "Doula Love", url: "http://www.portlanddoulalove.com", description: "Full-spectrum doula services supporting growing families in the Pacific Northwest since 2013.", photo: "https://images.squarespace-cdn.com/content/v1/5e559cda0db322392272b7a2/2d2eb055-4677-4f77-83fb-fca04a16d5b9/2024+Doula+Love-35.jpg", services: ["Postpartum", "Evidence-Based Care"], acceptsMedicaid: true, costRange: "Contact for pricing" },
      { name: "Pro Doula Natalie", credential: "Birth Doula", practice: "Pro Doula Natalie", url: "https://doulamatch.net/profile/40654/natalie-budey", description: "Birth and postpartum doula serving the Vancouver area with prenatal support, home birth experience, and doula training.", photo: "https://doulamatch.net/static/img/profile-doula.png", services: ["Birth Doula", "Postpartum", "Prenatal Care", "Home Birth", "Doula Training"], costRange: "$650–$1100" },
      { name: "Columbia Crossings Doula Services", credential: "Birth Doula", practice: "Columbia Crossings Doula Services", url: "https://www.facebook.com/columbiacrossingsdoulas", description: "Professional doula serving families in the Vancouver-Portland metro area.", photo: "", costRange: "Contact for pricing" },
      { name: "Inna Hudz", credential: "Birth Doula", practice: "Inna Hudz", url: "https://innahudz.com", description: "WA State Certified birth doula and Medicaid provider offering faith-based, Russian-speaking doula support for Vancouver families.", photo: "https://static.showit.co/1600/cyE0_7pCTn6YtYKR9xB1BQ/94074/innahudz_wedding_image.jpg", costRange: "Contact for pricing" },
      { name: "DeLightFull Beginnings , DOULA DÈ, De'Junique Brown", credential: "Birth Doula, Lactation Support", practice: "DeLightFull Beginnings , DOULA DÈ, De'Junique Brown", url: "http://doulade.com", description: "Birth doula, lactation support, and placenta encapsulation services for families in the Portland-Vancouver area.", photo: "https://images.squarespace-cdn.com/content/v1/614910a084d6241777888b47/a9a657d6-ef49-4757-95b0-4422410473fe/IMG_3639.jpeg", services: ["Birth Doula", "Postpartum", "Lactation", "Breastfeeding Support", "Placenta Encapsulation"], costRange: "Contact for pricing" },
      { name: "Skye the Doula", credential: "Birth Doula", practice: "Skye the Doula", url: "https://www.linkedin.com/in/skye-stephenson-9a078020a", description: "Professional doula serving families in the Vancouver-Portland metro area.", photo: "", costRange: "Contact for pricing" },
      { name: "Monarch Midwifery", credential: "LM, CPM", practice: "Monarch Midwifery", url: "http://www.monarchmidwifery.com", description: "Licensed midwife serving SW Washington and NW Oregon with personalized home birth care and comprehensive prenatal support.", photo: "https://images.squarespace-cdn.com/content/v1/61915587c99cd4398b97b2c7/ca0549de-fa2e-4ee1-8eb9-a7c5020fdb1a/Monarch-09.jpg", services: ["Home Birth"], isMidwife: true, costRange: "Contact for pricing" },
      { name: "Vancouver Clinic | OBGYN & Midwifery Department", credential: "CNM", practice: "Vancouver Clinic | OBGYN & Midwifery Department", url: "https://tvc.org/services/ob-gyn", description: "Certified nurse-midwives providing complete prenatal care, monitoring, and birth advocacy throughout pregnancy and delivery at Vancouver Clinic.", photo: "https://www.tvc.org/wp-content/uploads/Midwifery-1-688x455.jpg", services: ["Postpartum", "Breastfeeding Support", "Prenatal Care", "Water Birth", "Sibling Support"], acceptsMedicaid: true, isMidwife: true, costRange: "Contact for pricing" },
      { name: "Nest Midwifery", credential: "LM", practice: "Nest Midwifery", url: "http://www.nest-midwifery.com", description: "Licensed midwife offering home birth, postpartum care, and childbirth education serving Portland-Vancouver families.", photo: "https://babynestbirth.com/wp-content/uploads/2017/05/babynestbaby_resize-e1520558528463.jpg", services: ["Birth Doula", "Postpartum", "Placenta Encapsulation", "Childbirth Education", "Overnight Care"], acceptsMedicaid: true, isMidwife: true, costRange: "Contact for pricing" },
      { name: "Hearth and Home Midwifery", credential: "CPM", practice: "Hearth and Home Midwifery", url: "https://hearthandhomemidwifery.com/?utm_source=googlebusinessprofile&utm_medium=organic&utm_campaign=gbpwebsitelink", description: "Certified Professional Midwives offering licensed home birth services and prenatal care for Vancouver, Washington families.", photo: "https://images.squarespace-cdn.com/content/v1/58dc480344024326ef955f75/1564438774962-4F446EJNCAYWKAELTIAX/hh-logo-105.png", services: ["Postpartum", "Prenatal Care", "Home Birth"], isMidwife: true, costRange: "Contact for pricing" },
      { name: "Suwannee Doula and Infant Care", credential: "Postpartum Doula", practice: "Suwannee Doula and Infant Care", url: "http://suwanneedoulacare.com", description: "Postpartum and overnight doula care serving Vancouver families. Specializing in breastfeeding support and overnight newborn care.", photo: "https://img1.wsimg.com/isteam/ip/850a11fe-671e-4c7f-8194-598ca4291beb/blob-3055cb9.png", services: ["Postpartum", "Breastfeeding Support", "Overnight Care"], costRange: "$1,200–$2,800" },
      { name: "EnCourage Doula Care LLC", credential: "Birth Doula", practice: "EnCourage Doula Care LLC", url: "https://www.encouragedoulacare.com", description: "Birth and bereavement doula serving Vancouver and Portland metro families. Offering childbirth education, breastfeeding support, and prenatal care.", photo: "https://static.wixstatic.com/media/692a5c_3a7fd8756b55414bbff5b3e0758243b0~mv2.jpg/v1/fill/w_189,h_216,al_c,q_80,usm_0.66_1.00_0.01,enc_avif,quality_auto/headshot%202024.jpg", services: ["Birth Doula", "Postpartum", "Breastfeeding Support", "Childbirth Education", "Prenatal Care"], costRange: "$2400–$2700", acceptsMedicaid: true },
      { name: "Heather Ward Birth Doula", credential: "Birth Doula", practice: "BirthLore", url: "http://www.birthlore.com", description: "Experienced birth and postpartum doula offering breastfeeding support and prenatal education for Vancouver families.", photo: "https://birthlore.com/wp-content/uploads/2023/06/IMG_1121.jpg", services: ["Breastfeeding Support", "Prenatal Care"], costRange: "$1,200–$2,800" },
      { name: "Birth First Doulas Portland", credential: "Birth Doula", practice: "Birth First Doulas Portland", url: "https://www.birthfirstdoulas.com/?utm_source=GMB&utm_medium=organic&utm_campaign=local", description: "Doula matching service connecting Portland-Vancouver families with experienced birth doulas, postpartum doulas, and educators.", photo: "https://birthfirstdoulas.com/wp-content/uploads/2019/10/portland-doula-pregnant-woman.jpg", services: ["Birth Doula", "Postpartum", "Breastfeeding Support", "Placenta Encapsulation", "Overnight Care"], acceptsMedicaid: true, costRange: "$1,200–$2,800" },
      { name: "Rachel J Gathright Doula Birth - Postpartum - Placenta", credential: "Birth Doula", practice: "Rachel J Gathright Doula Birth - Postpartum - Placenta", url: "http://racheljgathright.com", description: "Birth doula, postpartum support, and placenta services for Portland-Vancouver families. Helping you feel prepared and supported.", photo: "https://images.squarespace-cdn.com/content/v1/61f2f2124d792a3258a2c20f/350a816b-636e-46b5-a39e-c59d4e135a47/RachelYellow.jpg", costRange: "$1,200–$2,800" },
      { name: "Doula Love", credential: "Postpartum Doula", practice: "Doula Love", url: "http://www.portlanddoulalove.com", description: "Full-spectrum doula services supporting growing families in the Pacific Northwest since 2013.", photo: "https://images.squarespace-cdn.com/content/v1/5e559cda0db322392272b7a2/2d2eb055-4677-4f77-83fb-fca04a16d5b9/2024+Doula+Love-35.jpg", services: ["Postpartum", "Evidence-Based Care"], acceptsMedicaid: true, costRange: "$1,200–$2,800" },
      { name: "Pro Doula Natalie", credential: "Birth Doula", practice: "Pro Doula Natalie", url: "https://doulamatch.net/profile/40654/natalie-budey", description: "Birth and postpartum doula serving the Vancouver area with prenatal support, home birth experience, and doula training.", photo: "https://doulamatch.net/static/img/profile-doula.png", services: ["Birth Doula", "Postpartum", "Prenatal Care", "Home Birth", "Doula Training"], costRange: "$650–$1100" },
      { name: "Columbia Crossings Doula Services", credential: "Birth Doula", practice: "Columbia Crossings Doula Services", url: "https://www.facebook.com/columbiacrossingsdoulas", description: "Professional doula serving families in the Vancouver-Portland metro area.", costRange: "$1,200–$2,800" },
      { name: "Inna Hudz", credential: "Birth Doula", practice: "Inna Hudz", url: "https://innahudz.com", description: "WA State Certified birth doula and Medicaid provider offering faith-based, Russian-speaking doula support for Vancouver families.", photo: "https://static.showit.co/1600/cyE0_7pCTn6YtYKR9xB1BQ/94074/innahudz_wedding_image.jpg", costRange: "$1,200–$2,800" },
      { name: "DeLightFull Beginnings , DOULA DÈ, De’Junique Brown", credential: "Birth Doula, Lactation Support", practice: "DeLightFull Beginnings , DOULA DÈ, De’Junique Brown", url: "http://doulade.com", description: "Birth doula, lactation support, and placenta encapsulation services for families in the Portland-Vancouver area.", photo: "https://images.squarespace-cdn.com/content/v1/614910a084d6241777888b47/a9a657d6-ef49-4757-95b0-4422410473fe/IMG_3639.jpeg", services: ["Birth Doula", "Postpartum", "Lactation", "Breastfeeding Support", "Placenta Encapsulation"], costRange: "$1,200–$2,800" },
      { name: "Skye the Doula", credential: "Birth Doula", practice: "Skye the Doula", url: "https://www.linkedin.com/in/skye-stephenson-9a078020a", description: "Professional doula serving families in the Vancouver-Portland metro area.", costRange: "$1,200–$2,800" },
      { name: "Monarch Midwifery", credential: "LM, CPM", practice: "Monarch Midwifery", url: "http://www.monarchmidwifery.com", description: "Licensed midwife serving SW Washington and NW Oregon with personalized home birth care and comprehensive prenatal support.", photo: "https://images.squarespace-cdn.com/content/v1/61915587c99cd4398b97b2c7/ca0549de-fa2e-4ee1-8eb9-a7c5020fdb1a/Monarch-09.jpg", services: ["Home Birth"], isMidwife: true, costRange: "$1,200–$2,800" },
      { name: "Vancouver Clinic | OBGYN & Midwifery Department", credential: "CNM", practice: "Vancouver Clinic | OBGYN & Midwifery Department", url: "https://tvc.org/services/ob-gyn", description: "Certified nurse-midwives providing complete prenatal care, monitoring, and birth advocacy throughout pregnancy and delivery at Vancouver Clinic.", photo: "https://www.tvc.org/wp-content/uploads/Midwifery-1-688x455.jpg", services: ["Postpartum", "Breastfeeding Support", "Prenatal Care", "Water Birth", "Sibling Support"], acceptsMedicaid: true, isMidwife: true, costRange: "$1,200–$2,800" },
      { name: "Nest Midwifery", credential: "LM", practice: "Nest Midwifery", url: "http://www.nest-midwifery.com", description: "Licensed midwife offering home birth, postpartum care, and childbirth education serving Portland-Vancouver families.", photo: "https://babynestbirth.com/wp-content/uploads/2017/05/babynestbaby_resize-e1520558528463.jpg", services: ["Birth Doula", "Postpartum", "Placenta Encapsulation", "Childbirth Education", "Overnight Care"], acceptsMedicaid: true, isMidwife: true, costRange: "$1,200–$2,800" },
      { name: "Hearth and Home Midwifery", credential: "CPM", practice: "Hearth and Home Midwifery", url: "https://hearthandhomemidwifery.com/?utm_source=googlebusinessprofile&utm_medium=organic&utm_campaign=gbpwebsitelink", description: "Certified Professional Midwives offering licensed home birth services and prenatal care for Vancouver, Washington families.", photo: "https://images.squarespace-cdn.com/content/v1/58dc480344024326ef955f75/1564438774962-4F446EJNCAYWKAELTIAX/hh-logo-105.png", services: ["Postpartum", "Prenatal Care", "Home Birth"], isMidwife: true, costRange: "$1,200–$2,800" },
],
    ...
    faqs: [
      ...
      { q: "Are there birth centers in Vancouver?", a: "Yes \u2014 The Bridge Birth Center is Vancouver's freestanding birth center, offering full-service midwifery care at 3300 NE 54th Street. Both PeaceHealth Southwest and Legacy Salmon Creek also offer midwifery-model care within the hospital setting. <a href=\"/birth-plan-template/\">Grab the free birth plan template</a> to think through your options." },
  ...
  "moreno-valley-ca": {
    ...
    heroImage: "/images/moreno-valley-ca-birth-doula-skyline.webp",
    ogImage: "https://truejoybirthing.com/images/og-city-moreno-valley-ca.webp",
    enableBlogResources: true,
    supportSceneAlt: "A doula walking alongside an expectant mom in Moreno Valley, California",
    supportSceneImage: "/images/moreno-valley-ca-support-scene.webp",
    midwifeInfo: {
    ...
    localDoulas: [
      ...
      { name: "Raising Birth Doula Care", credential: "Birth Doula", practice: "Raising Birth Doula Care", url: "https://www.instagram.com/raisingbirthdoula", description: "Birth doula serving families in the Inland Empire. Contact via Instagram for availability and pricing.", photo: "/images/doulas/placeholder-doula.png", services: ["Birth Doula"], costRange: "Contact for pricing" },
    ],
  ...
  "fontana-ca": {
    ...
    state: "CA",
    slug: "fontana-ca",
    heroImage: "/images/fontana-ca-birth-doula-skyline-v4.jpg",
    ogImage: "https://truejoybirthing.com/images/og-city-fontana-ca-v4.jpg",
    enableBlogResources: true,
  ...
  "san-bernardino-ca": {
    ...
    heroImage: "/images/sb-hero-v2.jpg",
    ogImage: "https://truejoybirthing.com/images/og-city-san-bernardino-ca.webp",
    enableBlogResources: true,
    supportSceneAlt: "A doula walking alongside an expectant mom in San Bernardino, California",
    supportSceneImage: "/images/sb-support-v2.jpg",
    midwifeInfo: {
    ...
    costHigh: 2500,
    shelbiServesHere: false,
    culture: "San Bernardino is the largest city in the Inland Empire by land area, serving as a regional hub for healthcare with two Dignity Health hospitals providing maternity care. The birth community reflects the city's diverse population, with a strong Spanish-speaking doula community and growing Medi-Cal doula enrollment through the PAVE program. The San Bernardino Mountains provide a dramatic backdrop, and families here benefit from the region's expanding birth support infrastructure.",
    heroLocalDetail: "At 38 weeks in San Bernardino, you're likely planning the drive to either St. Bernardine Medical Center on Highland Avenue or Community Hospital on Medical Center Drive. The 210 and 215 freeways can back up significantly during commute hours. If you're delivering during rush hour, give yourself extra time — especially if you're coming from the mountain communities like Crestline or Running Springs. Shandin Hills Golf Course and the San Bernardino National Forest offer walking trails for those final-weeks strolls.",
    hospitalDetails: [
      { name: "Dignity Health - St. Bernardine Medical Center", thumbnail: "/images/sb-hospital-v2.jpg", paragraph: "St. Bernardine Medical Center is a 340-bed acute care hospital serving the Inland Empire with a full obstetrics program. The Baby & Family Center offers educational programs, childbirth classes, and support groups for families. Doulas are generally welcome — confirm current visitor policies during your hospital tour. If you're delivering here, having your birth plan ready makes the whole check-in process smoother. <a href=\"/birth-plan-template/\">Use our free hospital birth plan template</a> to get started.", address: "2101 N Waterman Ave, San Bernardino, CA 92404", url: "https://www.commonspirit.org/find-a-location/dignity-health-st-bernardine-medical-center-3756" },
      { name: "Dignity Health - Community Hospital of San Bernardino", thumbnail: "/images/community-hospital-san-bernardino.webp", paragraph: "Community Hospital of San Bernardino is a not-for-profit, award-winning hospital with a dedicated Family Birth Center. For more than a century, this hospital has served local families, working hand in hand with St. Bernardine Medical Center. The Family Birth Center offers maternity tours and classes. Doulas are welcome, and the hospital is especially known for its maternity and behavioral health services. <a href=\"/birth-plan-template/\">Use our free hospital birth plan template</a> to get started.", address: "1805 Medical Center Dr, San Bernardino, CA 92411", url: "https://www.commonspirit.org/find-a-location/dignity-health-community-hospital-of-san-bernardino-3876" },
    ],
    // Birth center search: NPI taxonomy 261QB0400X returned results for San Bernardino CA.
    // Google Maps search "birth center San Bernardino CA" found freestanding birth centers.
    // Verified 2026-06-12.
    birthCenterDetails: [
    ],
    localDoulas: [
      { name: "Doula127 - Doula Services", credential: "Birth Doula", practice: "Doula127 - Doula Services", url: "", description: "Birth doula offering labor support and birth planning assistance to San Bernardino families.", photo: "/images/doulas/doula127-san-bernardino.webp", costRange: "Contact for pricing", acceptingClients: false },
      { name: "Holistic Doula LLC", credential: "Birth Doula", practice: "Holistic Doula LLC", url: "https://www.holistic-doula.com", description: "Holistic Doula LLC provides culturally sensitive bilingual doula support for Latina women and families across the Inland Empire. Services include pregnancy, birth, and postpartum support with Home Visitation and coverage through IEHP and Kaiser.", photo: "/images/doulas/moreno-valley-ca-holistic-doula.webp", services: ["Birth Doula", "Postpartum", "Prenatal Care"], costRange: "Contact for pricing" },
      { name: "4 The Moms Southern California Postpartum Doula Support", credential: "Postpartum Doula", practice: "4 The Moms Southern California Postpartum Doula Support", url: "https://www.4themoms.org", description: "4 The Moms is a holistic, evidence-based postpartum doula service supporting families through the 4th trimester — bringing home your baby. Serving the Inland Empire, Coachella Valley, and Orange County with in-home care including emotional support, lactation guidance, newborn care, overnight shifts, and birth recovery support.", photo: "/images/doulas/moreno-valley-ca-4themoms.webp", services: ["Postpartum", "Lactation", "Breastfeeding Support", "Overnight Care"], costRange: "Contact for pricing" },
      { name: "Two Moons Doula Services", credential: "Birth Doula", practice: "Two Moons Doula Services", url: "https://m.yelp.com/biz/two-moons-doula-services-san-bernardino-county-3", description: "Formerly offered birth doula support, Bengkung belly binding, yoni steaming, and Closing of the Bones ceremonies in San Bernardino County. This practice is currently closed.", photo: "", costRange: "Contact for pricing", acceptingClients: false },
      { name: "Raising Birth Doula Care", credential: "Birth Doula", practice: "Raising Birth Doula Care", url: "https://www.instagram.com/raisingbirthdoula", description: "Birth doula serving Inland Empire families with personalized labor support, prenatal education, and postpartum care.", photo: "", costRange: "Contact for pricing" },
      { name: "Birthy Matters Doula Services and Birth Photography", credential: "Birth Doula", practice: "Birthy Matters Doula Services and Birth Photography", url: "", description: "Birth doula and birth photography services for San Bernardino families, offering continuous labor support and birth storytelling.", photo: "", costRange: "Contact for pricing" },
    ],
    medicaidNote: "Yes — California's Medi-Cal program covers doula services as a state benefit, with reimbursement rates around $1,587 per pregnancy. Families on Medi-Cal can access doula support through the PAVE (Providing Access and doula Viability through Equity) program. Ask your doula whether they are a PAVE-enrolled Medi-Cal provider.",
    insuranceNote: "In San Bernardino, many families have employer-sponsored insurance through Dignity Health, Kaiser Permanente, or Inland Empire health plans. Doula coverage by private insurers is expanding — check your specific plan for doula benefits. HSA and FSA funds can help cover out-of-pocket doula costs. Some IE doulas offer sliding-scale pricing for families without doula benefits.",
    faqs: [
      { q: "How much does a doula cost in San Bernardino?", a: "Expect to pay $1,200 to $2,500 for a doula in San Bernardino. Inland Empire rates are generally lower than Los Angeles or Orange County. The investment typically covers prenatal visits, labor support, and postpartum check-ins. <a href=\"/birth-plan-template/\">Download the free birth plan template</a> and start thinking about what matters most to you." },
      { q: "Does Medi-Cal cover doulas in San Bernardino?", a: "Yes — California's Medi-Cal program covers doula services, reimbursing around $1,587 per pregnancy. Doulas enroll through the PAVE program. This is a well-established benefit, not a pilot — ask your doula upfront whether they accept Medi-Cal. <a href=\"/birth-plan-template/\">Grab the free birth plan template</a> and make sure your doula team knows your preferences." },
      { q: "Which hospitals in San Bernardino accommodate birth plans?", a: "St. Bernardine Medical Center and Community Hospital of San Bernardino both accommodate birth plans. Both are Dignity Health facilities with Family Birth Centers. Doulas are generally welcome at both — confirm current visitor policies during your hospital tour. <a href=\"/birth-plan-template/\">Grab the free birth plan template</a> so you walk in prepared." },
      ...
      { q: "Does True Joy Birthing work with San Bernardino families?", a: "True Joy Birthing provides free birth-prep tools for San Bernardino families. The free birth plan, checklist, and guided walkthrough in the app work for any San Bernardino birth setting. The app also helps you connect with local doulas and midwives in your area." },
      { q: "What about postpartum support in San Bernardino?", a: "San Bernardino has hospital-based lactation support at both Dignity Health hospitals. The Inland Empire postpartum doula community is growing. Start your search during pregnancy if you want ongoing postpartum support. <a href=\"/postpartum-doula/\">Learn more about postpartum doula support</a>." },
    ],
    nearbyCities: ["riverside-ca", "fontana-ca", "rancho-cucamonga-ca", "ontario-ca"],
    publishedDate: "2026-06-12",
    lat: 34.1412,
    lng: -117.2936,
  },
  "chesapeake-va": {
    ...
    supportSceneImage: "/images/chesapeake-va-support-scene.webp",
    midwifeInfo: {
    ...
    localDoulas: [
      ...
      { name: "Wholesome Hearts Doula Services", credential: "Birth Doula", practice: "Wholesome Hearts Doula Services", url: "https://www.facebook.com/WholesomeHeartsDoula", description: "Professional doula serving families in the Chesapeake area.", photo: "/images/doulas/wholesome-hearts-chesapeake-va.webp", costRange: "Contact for pricing" },
      { name: "The Village Midwife Birth Center", credential: "LM, CPM, DEM", practice: "The Village Midwife Birth Center", url: "https://www.thevillagemidwife.com", description: "Home, birth center, and hospital birth options with the only low-cost maternity clinic in SE Virginia. Accepts Medicaid and offers payment plans. Trauma-informed care from an experienced LM, CPM, DEM.", photo: "https://images.squarespace-cdn.com/content/v1/6914d73b6bb72f3b99693f92/5f600f66-c79f-499f-89df-9b78fa89a2d1/TVM+Baby+Scale+2+Lights+On+Small.jpeg", services: ["Postpartum", "VBAC Support", "Home Birth", "Evidence-Based Care"], acceptsMedicaid: true, isVerified: true, isMidwife: true, costRange: "Contact for pricing" },

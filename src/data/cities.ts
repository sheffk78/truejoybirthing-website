...
"killeen-tx": {
    ...
    localDoulas: [
      ...
      { name: "My Neighborhood Doula", credential: "Certified Birth Doula", practice: "My Neighborhood Doula", url: "https://myneighborhooddoula.com/", description: "Certified birth doula team serving Temple, Belton, Waco, Killeen, and surrounding Central Texas communities. Offers birth doula support, childbirth education classes, and postpartum care. Their $1,400 package includes prenatal visits, 24/7 on-call support, continuous labor support, and postpartum follow-up.", services: ["Birth Doula", "Childbirth Education", "Postpartum"], costRange: "$1,400", serviceArea: ["Temple", "Belton", "Waco", "Killeen", "Central Texas"], acceptingClients: true, photo: "" },
    ],

...
img = Image.open(r"/Users/socializerender/.openclaw/workspace/Kit/life/brands/TrueJoyBirthing/projects/truejoybirthing-website/public/images/bakersfield-ca-birth-doula-skyline-v2.webp").convert("RGB")
w, h = img.size
